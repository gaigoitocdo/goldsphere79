<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/51.79.209.207/application/index/view/user/cashlist2.html";i:1755612850;}*/ ?>
        ...
        <ion-nav-view class="view-container" nav-view-transition="ios" nav-view-direction="none" nav-swipe="">
            <ion-tabs class="tabs-icon-top navbar pane tabs-bottom tabs-standard" abstract="true" nav-view="active"
                ...
                <ion-nav-bar class="bar-stable headerbar nav-bar-container" nav-bar-transition="ios"
                             nav-bar-direction="swap" nav-swipe="" style="background:linear-gradient(90deg,#00527a,#00537f)!important;">

                    <div class="nav-bar-block" nav-bar="active">
                        <ion-header-bar onclick="javascript:history.back(-1)" class="bar-stable headerbar bar bar-header" align-title="center" style="background:linear-gradient(90deg,#00527a,#00537f) !important;">
