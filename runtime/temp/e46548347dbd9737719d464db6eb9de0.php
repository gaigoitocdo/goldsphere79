<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/isetradingstar.com/application/lord/view/price/allot.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747522285;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1690047148;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<!--main content start-->
      <section id="main-content">
          <section class="wrapper">
            ...
            <a href="<?php echo url('price/allot'); ?>"><button type="submit" class="btn btn-danger">Tìm kiếm tất cả</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <!--
			<a href="javascript:;"><button type="submit" class="btn btn-danger"><?php echo $count; ?></button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            -->
            <br><br>
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <!-- <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td><a href="<?php echo url('order/orderlist'); ?>?oid=<?php echo $vo['oid']; ?>"><?php echo $vo['oid']; ?>(Nhấp để xem)</a></td>
