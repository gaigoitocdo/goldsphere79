...
<section id="main-content">
  <section class="wrapper">
    <!-- form filter giữ nguyên -->
    <div class="row">
      <div class="col-lg-12">
        <section class="panel">
          <header class="panel-heading">Lịch sử trả lãi</header>
          <table class="table table-striped table-advance table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo (isset($vo['project_title']) && ($vo['project_title'] !== '')?$vo['project_title']:'-'); ?></td>
                <td><?php echo $vo['interest_amount']; ?></td>
    ...
    <?php echo $logs->render(); ?> <!-- đúng biến -->
