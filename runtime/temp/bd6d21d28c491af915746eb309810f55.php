                      ...
                      <aside class="profile-nav alt green-border">
                          <section class="panel">
                              <div class="user-heading alt green-bg">
                                  <a href="#">
                                      <img alt="" src="<?php echo $portrait; ?>">
                                  </a>
                                  <h1>Tên đăng nhập：<?php echo $nickname; ?></h1>
                                  <p>Tên đăng nhập: <?php echo $username; ?></p>
                                  <p>Số dư：<?php if(isset($usermoney)): ?><?php echo $usermoney; else: ?>0<?php endif; ?></p>
                              </div>
                              ...
                              <div class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Mã Lệnh：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $orderno; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $ptitle; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Trạng thái Lệnh：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php if($ostaus == 1): ?>Đóng cửa<?php else: ?>Mở cửa<?php endif; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Giá mua vào：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $buyprice; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Giá đóng cửa：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $sellprice; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Số tiền mua vào：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $fee; ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Thời gian mua vào：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo date("Y-m-d H:i:s",$buytime); ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Thời gian đóng cửa：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo date("Y-m-d H:i:s",$selltime); ?></p>
                                      </div>
                                  </div>
									<hr>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Lãi/lỗ Lệnh：</label>
                                      <div class="col-lg-6">
                                          <p class="control-label"><?php echo $ploss; ?></p>
                                      </div>
                                  </div>
