<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/51.79.188.227/hosetrade/application/index/view/user/cpaypassword.html";i:1694961976;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0038)/change/password -->
<html lang="en" mode="md" class="plt-desktop md hydrated">
			...
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.99381</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.64073</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">7.2726</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">1.36194</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">147.813</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.99647</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">1.57872</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">171.37538
																			</div>
																		</div>
																	</ion-col>
																</ion-row>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.8052</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.15915</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
					...
					<div class="" style="z-index: 101;">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner">
							<!---->
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display: flex;align-items: center;padding: 10px 20px;">
								...
								<ion-title class="md title-default hydrated"><?php echo lang('xgzfmm'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" style="--offset-top:56px; --offset-bottom:0px;">
							<div class="repwd-box">
								<div class="text-header"><?php echo lang('mmts'); ?></div>
								
								<div class="from">
								    <div class="lable"><?php echo lang('username'); ?></div>
									<div class="r-input">
										<ion-input modelvalue=""
											class="sc-ion-input-md-h sc-ion-input-md-s md hydrated">
											<input class="native-input sc-ion-input-md" name="nickname" id="nickname"
												placeholder="<?php echo lang('sryhm'); ?>" type="text"></ion-input>
									</div>
									<div class="lable"><?php echo lang('xmm'); ?></div>
									<div class="r-input">
										<ion-input modelvalue=""
											class="input-password sc-ion-input-md-h sc-ion-input-md-s md hydrated">
											<input class="native-input sc-ion-input-md"
												aria-labelledby="ion-input-114-lbl" autocapitalize="off"
												autocomplete="off" autocorrect="off" name="upwd" id="upwd"
												placeholder="<?php echo lang('srxmm'); ?>" spellcheck="false" type="text"><button
												aria-label="reset" type="button"
												class="input-clear-icon sc-ion-input-md"></button></ion-input>
									</div>
									<div class="lable"><?php echo lang('qrmm'); ?></div>
									<div class="r-input">
										<ion-input modelvalue=""
											class="input-password sc-ion-input-md-h sc-ion-input-md-s md hydrated">
											<input class="native-input sc-ion-input-md"
												aria-labelledby="ion-input-115-lbl" autocapitalize="off"
												autocomplete="off" autocorrect="off" name="upwd2" id="upwd2"
												placeholder="<?php echo lang('zcsrxmm'); ?>" spellcheck="false" type="text"><button
												aria-label="reset" type="button"
												class="input-clear-icon sc-ion-input-md"></button></ion-input>
									</div>
								</div>
								<button class="md button button-block button-solid ion-activatable ion-focusable hydrated" expand="block" style="margin-top: 40px;width: 100%;background: #ebcc7f;padding: 12px;border-radius: 5px;" onclick="checkform2();"><?php echo lang('qrxg'); ?></button>
	...
	function checkform2(){
        ...
        if (!nickname) {
            layer.msg('<?php echo lang('qsryx'); ?>');
            return false;
        }

        if (!upwd) {
            layer.msg('<?php echo lang('qsrdlmm'); ?>');
            return false;
        }

        if (!upwd2) {
            layer.msg('<?php echo lang('qzcsrdlmm'); ?>');
            return false;
        }

        if (upwd.length < 8 || upwd2.length < 8) {
            layer.msg('<?php echo lang('mmcdbg'); ?>');
            return false;
        }

        if (upwd != upwd2) {
            layer.msg('<?php echo lang('lcmmbyy'); ?>');
            return false;
        }
        $.post('/index/user/cpaypassword',{'nickname':nickname,'upwd':upwd,'upwd2':upwd2},function(data){
            if(data.type==1){
