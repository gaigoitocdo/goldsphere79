<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/isetradingstar.com/application/lord/view/user/chongzhi.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                ...
                <div class="row">
                     <div class="col-lg-3 mar-10">
                      <div class="input-group">
                              ...
                              <input type="text" value="" placeholder="Nhập ID người dùng" name="utel" class="form-control">
                          </div>
                      </div>
                      <div class="col-lg-5 mar-10">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"  value=""  class="form-control" name="bpprice" placeholder="Nhập số tiền nạp"/>
                        </div>
                      </div>

                      
                  <div class="mar-10">
                   <input type="submit" onclick="return editcon(this.form)" class="btn btn-success" value="Gửi">
                  </div>
                </div>
                </form>
              </div>
...
<script>
  function editcon(form){
    ...
    if(!utel){layer.msg('Vui lòng nhập ID người dùng'); return false;}
