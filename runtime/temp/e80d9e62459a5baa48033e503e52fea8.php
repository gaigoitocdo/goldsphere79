<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/51.79.188.227/hosetrade/application/index/view/user/paymode.html";i:1694961976;}*/ ?>
<!DOCTYPE html>
			...
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
					<div class="" style="z-index: 99;">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner" style="margin-top:18px">
							<!---->
