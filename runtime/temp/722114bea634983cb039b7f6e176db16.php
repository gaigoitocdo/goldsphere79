<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/isetradingstar.com/application/lord/view/index/index.html";i:1690284776;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row index_top_user">
                <h2>Số người dùng mới hôm nay：<?php echo $data['tody_user']; ?> &nbsp;&nbsp;&nbsp;&nbsp;Tổng số người dùng: <?php echo $data['all_user']; ?>&nbsp;&nbsp;&nbsp;&nbsp;
                  Tổng số dư người dùng: <?php echo $data['all_usermoney']; ?></h2>
              </div>
              <div class="row state-overview">
                  <div class="col-lg-2 col-sm-2">
                      <section class="panel">
                          <div class="symbol red color_white">
                              <h4>Số lệnh<br>hôm nay</h4>
                          </div>
                          <div class="value">
                  ...
                  <div class="col-lg-2 col-sm-2">
                      <section class="panel">
                          <div class="symbol gray color_white">
                              <h4>Phí giao dịch<br>Hôm nay</h4>
                          </div>
                          <div class="value">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              Ghi chép giao dịch mới nhất
                              <a href="<?php echo url('order/orderlist'); ?>"><span class="right">Xem thêm>></span></a>
                          </header>
                          ...
                          <!-- <?php if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): $i = 0; $__LIST__ = $order;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td>
                                      <button class="btn btn-primary btn-xs" title="Nhấp để xem"><i class="icon-list-alt"></i></button>
