...
<!--main content start-->
      <section id="main-content">
          <section class="wrapper">
            ...
            <a href="<?php echo url('price/yongjin'); ?>"><button type="submit" class="btn btn-danger">Tìm kiếm tất cả</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
