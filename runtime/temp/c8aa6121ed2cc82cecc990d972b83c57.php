<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/51.79.209.207/application/index/view/index/enter.html";i:1690284858;}*/ ?>
...
<body style="overflow:auto;overflow-x: hidden!important;width:100%">

<!--	<div class="header">
      蚂蚁达客		</div>-->

<div class="swiper-container swiper-container1 swiper-container-initialized swiper-container-horizontal swiper-container-ios"
     style="height:30%;">
    <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1875px, 0px, 0px);">
        <div class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev"
             data-swiper-slide-index="3" style="width: 375px;"><img
                src="http://img.1bangbang.com.cn/20200924/5f6c4e483c551.png" style="height:100%;width:100%">
        </div>
        <div class="swiper-slide swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 375px;"><img
                src="http://img.1bangbang.com.cn/20200814/5f363605efe6d.png" style="height:100%;width:100%">
        </div>
        <div class="swiper-slide" data-swiper-slide-index="1" style="width: 375px;"><img
                src="http://img.1bangbang.com.cn/20201202/5fc70c562540f.jpg" style="height:100%;width:100%">
        </div>
        <div class="swiper-slide" data-swiper-slide-index="2" style="width: 375px;"><img
                src="http://img.1bangbang.com.cn/20200814/5f362bf254d73.png" style="height:100%;width:100%">
        </div>
        <div class="swiper-slide swiper-slide-prev swiper-slide-duplicate-next" data-swiper-slide-index="3"
             style="width: 375px;"><img src="http://img.1bangbang.com.cn/20200922/5f695ee6c42a4.png"
                                        style="height:100%;width:100%"></div>
        <div class="swiper-slide swiper-slide-duplicate swiper-slide-active" data-swiper-slide-index="0"
             style="width: 375px;"><img src="/public/uploads/20200421/096f777082ae355b7fe2eb67472b0ec3.jpg"
                                        style="height:100%;width:100%"></div>
    </div>
    ...
    <table width="100%">
        ...
        <tr>
            <td style="vertical-align:middle">
                <svg t="1586946486716" class="icon" viewBox="0 0 1261 1024" version="1.1"
                     xmlns="http://www.w3.org/2000/svg" p-id="2291" width="25" height="25">
                    <path d="M1147.133 460.907H933.556c-24.231 0-43.857 19.731-43.857 44.031v13.743c0 24.335 19.627 44.031 43.857 44.031h213.577c24.231 0 43.857-19.696 43.857-44.031v-13.743c0-24.3-19.627-44.031-43.857-44.031zM651.579 83.011c-66.427 52.823-205.443 126.865-305.481 198.035l-0.139 0.069c-1.143 0.693-2.285 4.639-3.427 5.296-11.839 6.646-17.135 25.027-81.381 25.027H135.808c-32.157 0-52.131 15.057-52.131 49.015v301.846c0 33.957 18.311 50.711 52.131 50.711h125.861c63.935 0.104 69.127 18.346 80.896 24.993 1.143 0.657 2.25 4.604 3.427 5.296l0.139 0.069c96.889 71.169 236.839 150.993 305.481 201.635 20.665 15.265 89.411 42.093 89.411-52.235V131.229c0-94.361-69.3-64.211-89.446-48.219z m197.239 208.108c11.354 20.007 33.819 25.027 50.227 11.215l175.569-147.981c16.407-13.811 20.493-41.227 9.173-61.269l-6.439-11.319c-11.319-20.007-33.819-25.027-50.193-11.215L851.586 218.496c-16.407 13.846-20.527 41.261-9.173 61.269l6.404 11.354z m50.192 430.927c-16.407-13.811-38.873-8.793-50.227 11.181l-6.404 11.319c-11.354 20.007-7.2 47.423 9.173 61.269l175.569 147.946c16.407 13.811 38.873 8.793 50.193-11.181l6.439-11.319c11.319-20.007 7.2-47.423-9.173-61.269L899.011 722.046z"
                          p-id="2292" fill="#496ffe"></path>
                </svg>
            </td>
            <td style="padding-top:10px;height:30px;">
                <div class="swiper-container swiper-container-initialized swiper-container-vertical swiper-container-ios"
                     id="announce" style="height:30px;padding-right:10px;width:100%;overflow:hidden;">
                    <div class="swiper-wrapper"
                         style="transition-duration: 0ms; transform: translate3d(0px, -60px, 0px);">
                        <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                             style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 80%; height: 30px;"
                             data-swiper-slide-index="1"><a href="/index/index/detail.html?id=12"
                                                            style="color:black;width:80%">新会员注册入金享受7天免手续费提现！</a>
                        </div>
                        <div class="swiper-slide swiper-slide-prev swiper-slide-duplicate-next"
                             style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 80%; height: 30px;"
                             data-swiper-slide-index="0"><a href="/index/index/detail.html?id=13"
                                                            style="color:black;width:80%">晋级会员尊享更多福利优惠，联系客服了解详情！</a>
                        </div>
...
<div class="news" style="padding:10px;box-sizing:border-box;">
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=42'">
        <div style="width:70%">
            慈善募捐|西吉助学中心扩建  <p style="color:#b7b7b7">西吉县有这样的孩子家庭极度贫困辍学在家</p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20180622/5b2c9c87d2af5.jpg"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=40'">
        <div style="width:70%">
            慈善募捐|一座书屋受益一村人 <p style="color:#b7b7b7">解决贫困农村买书难、借书难、看书难</p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20180612/5b1f77f9709a0.png"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=39'">
        <div style="width:70%">
            慈善募捐|思源助学金 <p style="color:#b7b7b7"></p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20200708/5f0576050c62b.png"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=38'">
        <div style="width:70%">
            慈善募捐|水上记忆大碗茶“慈善助学项目” <p style="color:#b7b7b7">读书是中华民族的传统美德</p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20200430/5eaa31ed504c2.jpg"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=37'">
        <div style="width:70%">
            慈善募捐|爱是最好的良方 <p style="color:#b7b7b7">爱是最好的良方，为天线宝宝打开折叠人生</p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20191203/5de6076ec8de3.png"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=36'">
        <div style="width:70%">
            慈善募捐|慈父为白血女儿求救 <p style="color:#b7b7b7">牛若菡刚3岁9个月查出患有白血病，为此负</p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20181018/5bc81464b6d62.jpg"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=35'">
        <div style="width:70%">
            慈善募捐|新冠核酸检测移动实验室 <p style="color:#b7b7b7"></p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20200630/5efb04d8793fc.png"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
    <div style="display:flex;margin-bottom:20px;" onclick="location.href='/index/index/detail.html?id=34'">
        <div style="width:70%">
            慈善募捐|守护白衣天使计划 <p style="color:#b7b7b7">让我们一同守护我们的健康守卫者</p>
        </div>
        <div style="width:30%;">
            <img src="http://img.1bangbang.com.cn/20200131/5e33d0ebac655.jpg"
                 style="border-radius:5px;width:100%;height:70px;">
        </div>
    </div>
</div>
...
<div class="tab-nav tabs">
    <div class="tab-nav tabs" style="bottom:10px;">
        ...
        <a href="<?php echo Url('/index/index/enter/token/'.$token); ?>" style="width: 25%;text-align:center;"
           class="active">
            <svg t="1586934349905" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="7560" width="28" height="28">
                <path d="M559.6296875 107.65390625a67.6265625 67.6265625 0 0 0-90.871875 0L101.3046875 456.565625a33.89765625 33.89765625 0 0 0 45.39375 50.35078125l5.84296875-5.54765626V865.53125001a67.7953125 67.7953125 0 0 0 67.7953125 67.87968749h197.28984375v-204.103125a47.73515625 47.73515625 0 0 1 47.75625-47.7984375h92.83359375a47.73515625 47.73515625 0 0 1 47.75625 47.7984375v204.103125h201.97265625a67.7953125 67.7953125 0 0 0 67.81640625-67.87968751V505.81953125c15.0609375 13.6265625 36.42890625 12.59296875 48.95859375-1.37109375a33.89765625 33.89765625 0 0 0-2.446875-47.8828125L559.6296875 107.675z"
                      fill="#bfbfbf" p-id="7561"></path>
            </svg>
            <br>首页
        </a>


        <a href="<?php echo Url('/index/index/index/token/'.$token); ?>" style="width: 25%;text-align:center;">
            <svg t="1586934143438" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="4351" width="28" height="28">
                <path d="M491.093333 444.586667c-21.76 0-42.538667-4.309333-58.624-12.245334L112.085333 274.688c-21.930667-10.794667-34.56-28.117333-34.688-47.488-0.128-19.626667 12.586667-37.376 34.901334-48.725333L436.053333 14.08c17.066667-8.661333 39.04-13.397333 61.952-13.397333 21.76 0 42.538667 4.352 58.624 12.245333l320.384 157.653333c21.930667 10.794667 34.56 28.16 34.688 47.530667 0.128 19.626667-12.586667 37.376-34.901333 48.682667l-323.754667 164.394666c-17.066667 8.661333-39.04 13.44-61.994666 13.44zM424.533333 1023.36c-11.093333 0-22.613333-2.944-34.432-8.661333l-0.682666-0.384-286.293334-150.186667c-34.261333-16.938667-60.074667-53.205333-60.074666-84.48v-404.906667c0-28.373333 20.864-48.981333 49.536-48.981333 11.093333 0 22.613333 2.901333 34.432 8.661333l0.682666 0.341334 286.293334 150.186666c34.261333 16.938667 60.074667 53.205333 60.074666 84.522667v404.906667c0 28.373333-20.821333 48.981333-49.536 48.981333zM578.474667 1023.36c-28.714667 0-49.493333-20.608-49.493334-48.981333v-404.906667c0-31.317333 25.770667-67.584 60.032-84.48l286.976-150.570667c11.776-5.76 23.338667-8.661333 34.432-8.661333 28.672 0 49.493333 20.608 49.493334 48.981333v404.864c0 31.317333-25.770667 67.584-60.032 84.48l-286.976 150.613334a78.592 78.592 0 0 1-34.432 8.661333z"
                      p-id="4352" fill="#bfbfbf"></path>
            </svg>
            <br>
            商品
        </a>
        ...
        <a href="<?php echo url('/index/order/lixibao/token/'.$token); ?>" style="width: 25%;text-align:center;">
            <svg t="1586934202111" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="5254" width="28" height="28">
                <path d="M948.608 839.40352q0 18.240512-6.240256 34.079744t-17.760256 27.840512-26.88 18.719744-33.600512 6.720512l-696.96 0q-18.240512 0-34.56-6.720512t-28.8-18.719744-19.680256-27.840512-7.199744-34.079744l0-479.040512q0-36.48 25.440256-61.920256t61.920256-25.440256l696.96 0q36.48 0 61.920256 25.440256t25.440256 61.920256l0 130.56-217.920512 0q-36.48 0-61.920256 24.96t-25.440256 61.44q0.960512 24.96 10.560512 44.16 7.68 16.320512 25.440256 29.760512t51.359744 13.44l217.920512 0 0 174.72zM818.048 228.842496l-435.84 0q51.84-26.88 97.92-51.84 40.32-21.12 79.680512-42.24t61.44-32.64q33.600512-18.240512 60.000256-16.799744t44.640256 9.119744q21.12 10.560512 36.48 27.840512zM687.488 577.323008q0-18.240512 12.480512-30.72t30.72-12.480512 30.72 12.480512 12.480512 30.72-12.480512 31.200256-30.72 12.959744-30.72-12.959744-12.480512-31.200256z"
                      p-id="5255" fill="#bfbfbf"></path>
            </svg>
            <br>
            理财
        </a>
        <a href="<?php echo url('/ddd/kf'); ?>" style="width: 25%;text-align:center;">
            <svg t="1586934042875" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="3171" width="28" height="28">
                <path d="M870.1 562.4v-25.5c2-116.5-32.2-214.5-99.6-284-32.2-33.2-71-58.2-116-75.6-7.2-62.8-74.6-112.4-156.8-112.4-82.2 0-150.2 49.5-156.8 112.4-45 17.4-83.8 42.4-116 75.6-67.4 69.5-101.7 167-99.6 283.5v31.2c-17.4 17.9-31.2 44.4-20.9 82.2 7.7 28.1 28.1 48.5 53.1 57.7 12.8 8.2 27.6 12.8 43.9 12.8 32.2 141 148.1 237 299.9 237 151.7 0 267.7-96 299.9-237.5 1 0 2 0.5 3.1 0.5 19.9 0 38.3-7.2 53.1-18.9 18.9-10.7 33.7-29.1 39.8-52.1 10.7-41-7.2-69.1-27.1-86.9z m-88.9 77.1c0 18.9-1.5 36.8-4.1 54.1-49.5 79.7-131.3 131.8-232.9 143-7.7-10.2-23-16.9-40.9-16.9-25.5 0-46 13.8-46 31.2 0 16.9 20.4 31.2 46 31.2 23 0 41.4-11.2 45.5-26.1 32.7-3.6 63.9-11.7 93.5-23.5 41.9-16.9 78.7-41.9 109.8-73.6 5.1-5.1 9.7-10.2 14.3-15.8-36.8 113-135.4 185.5-263.6 185.5h-1c-165 0-279.9-119-279.9-289.1l-0.5-16.3c0-7.2 1-26.6 2-45 68.5-25 130.3-120.6 155.3-164.5 23 31.2 75.6 91.4 156.3 122.6 30.1 11.7 60.8 17.9 90.9 24.5 59.8 12.8 116.5 25 154.8 75.1l1.5 1.5-1 2.1z m0 0"
                      fill="#bfbfbf" p-id="3172"></path>
            </svg>
            <br>
            客服
        </a>
        <a href="<?php echo url('/index/user/index/token/'.$token); ?>" style="width: 25%;text-align:center;">
            <svg t="1586934231268" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="6735" width="28" height="28">
                <path d="M386.048 502.442667a227.555556 227.555556 0 1 1 251.875556 0C812.145778 556.174222 938.666667 718.421333 938.666667 910.222222a28.444444 28.444444 0 0 1-28.444445 28.444445H113.777778a28.444444 28.444444 0 0 1-28.444445-28.444445c0-191.800889 126.577778-354.048 300.714667-407.779555z"
                      fill="#bfbfbf" p-id="6736"></path>
            </svg>
            <br>
            个人
        </a>
    ...
    <script>
        ...
        function getData() {
            $.getJSON("/index/index/get_price.html?a=" + Math.random(), {}, function (data) {
                for (var i = 0; i < data.length; i++) {
                    var old = $(".cur_" + data[i].pid);
                    if (old > data[i].price) {
                        $(".cur_" + data[i].pid).text(data[i].price);
                        $(".cur_" + data[i].pid).css({'color': 'green'});
                    } else {
                        $(".cur_" + data[i].pid).text(data[i].price);
                        $(".cur_" + data[i].pid).css({'color': 'red'});
                    }
                }
            });
        }
