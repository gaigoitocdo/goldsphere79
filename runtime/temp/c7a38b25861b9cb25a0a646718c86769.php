<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/www/wwwroot/isetradingstar.com/application/lord/view/goods/proclass.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="col-sm-8">
                      <section class="panel">
                          <header class="panel-heading">
                              <h4 class="left">Danh mục sản phẩm</h4> 
                              <a href="javascript:;" onclick="addclass()"><span class="btn right btn-primary">Thêm danh mục+</span></a>
                              <br><br>
                          </header>
                          <table class="table">
                              <thead>
                      ...
                      <form class="form-horizontal" role="form" method="post" id="formid">
                          ...
                          <div class="form-group">
                              <div class="col-lg-offset-2 col-lg-10">
                                  <input type="submit" onclick="return formeidt(this.form)" class="btn btn-success" value="Lưu">
                              </div>
                          </div>
                      </form>
                  </div>
...
<script>
	...
	function editclass(id,data){
		$('.editadd').show();
		$('.f_title').html('Chỉnh sửa danh mục');
		$('#f-name').val(data);
		$('#f-id').val(id);
	}
		    ...
		    $.get(url,function(data){
		    	if (data.type == 1) {
		          layer.msg(data.data, {icon: 1,time: 1000},function(){
		            window.location.href="<?php echo Url('lord/goods/proclass'); ?>";
		          }); 
  ...
  function formeidt(form){
    ...
    if(!$pcname){
      layer.msg('Vui lòng nhập tên danh mục'); 
        return false;
    }
