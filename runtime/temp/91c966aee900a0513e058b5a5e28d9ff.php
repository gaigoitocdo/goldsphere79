...
<section id="main-content">
  <section class="wrapper">
            ...
            <div class="col-lg-3 mar-10">
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="username"
                       ...
                       value="<?php echo !empty($getdata['username'])?$getdata['username']:''; ?>">
              </div>
            </div>
            ...
            <div class="col-lg-3 mar-10">
              <div class="input-group">
                ...
                <select name="status" class="selectpicker show-tick form-control">
                  ...
                  <option <?php if(isset($getdata['status']) && $getdata['status'] == 1): ?>selected<?php endif; ?> value="1">Đang chạy</option>
                  <option <?php if(isset($getdata['status']) && $getdata['status'] == 2): ?>selected<?php endif; ?> value="2">Hoàn tất</option>
                </select>
              </div>
            </div>
            ...
            <div class="col-lg-3 mar-10">
              <div class="input-group">
                ...
                <input type="number" class="form-control" name="project_id"
                       value="<?php echo !empty($getdata['project_id'])?$getdata['project_id']:''; ?>" placeholder="VD: 12">
              </div>
            </div>
    ...
    <!--<a href="<?php echo url('project/investmentlist'); ?>">
      ...
      <div class="col-lg-12">
        <section class="panel">
          ...
          <table class="table table-striped table-advance table-hover">
            ...
            <tbody>
              <!-- <?php if(is_array($investment) || $investment instanceof \think\Collection || $investment instanceof \think\Paginator): $i = 0; $__LIST__ = $investment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
              <tr>
                <td><?php echo $vo['id']; ?></td>
                <td>
  <a class="btn btn-danger btn-xs" href="javascript:;" onclick="deleteInvestment(<?php echo $vo['id']; ?>)">Xóa</a>
</td>
                <td><?php echo $vo['uid']; ?></td>
                <td><?php echo $vo['username']; ?></td>
                <td><?php echo $vo['nickname']; ?></td>
                <td><?php echo $vo['project_title']; ?> (#<?php echo $vo['project_id']; ?>)</td>
                <td><?php echo $vo['amount']; ?></td>
                <td><?php echo $vo['daily_rate_snapshot']; ?></td>
                <td><?php echo $vo['start_at']; ?></td>
                <td><?php echo $vo['end_at']; ?></td>
                <td><?php echo $vo['next_interest_at']; ?></td>
                <td><?php echo $vo['total_interest_paid']; ?></td>
                <td>
                      <?php switch($vo['status']): case "1": ?><span class="success">Đang chạy</span><?php break; case "2": ?><span class="muted">Hoàn tất</span><?php break; default: ?><span class="muted">-</span>
                      <?php endswitch; ?>
                </td>
              </tr>
...
function deleteInvestment(id){
  layer.open({
    ...
    yes: function(){
      $.post("<?php echo url('project/investmentdel'); ?>", {id:id}, function(res){
        layer.msg(res.data);
