<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/51.79.209.207/application/index/view/user/cpaypassword.html";i:1755802543;}*/ ?>
<!DOCTYPE html>
...
<html lang="en" mode="md" class="plt-desktop md hydrated">
	<head>
		...
		<title><?php echo lang('xgzfmm'); ?></title>
...
<div class="r-input password-wrapper">
  <ion-input modelvalue=""
    class="sc-ion-input-md-h sc-ion-input-md-s md hydrated">
    <input class="native-input sc-ion-input-md"
      
      name="upwd" id="upwd" placeholder="<?php echo lang('srxmm'); ?>"
      spellcheck="false" type="text">
  </ion-input>
  <!-- SVG icon con mắt -->
  <i class="fa-solid fa-eye toggle-password" onclick="togglePassword('upwd', this)"></i>
</div>
...
<div class="r-input password-wrapper">
  <ion-input modelvalue=""
    ...
    <input class="native-input sc-ion-input-md"
      ...
      name="upwd2" id="upwd2" placeholder="<?php echo lang('zcsrxmm'); ?>"
      spellcheck="false" type="text">
  </ion-input>
  <!-- SVG icon con mắt -->
  <i class="fa-solid fa-eye toggle-password" onclick="togglePassword('upwd2', this)"></i>
</div>
