<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/goldsphere79.com/application/index/view/login/login.html";i:1755612859;}*/ ?>
<!DOCTYPE html>
...
.login .login-box[data-v-ebea41ae]{margin:50px auto 0}
					...
					<div class="ion-pages" data-v-ebea41ae="">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner">
							...
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display: flex;align-items: center;padding: 10px 20px;background:linear-gradient(90deg,#00527a,#00537f);color:#fff;justify-content:center;text-transform:uppercase">
								...
								<ion-title class="md title-default hydrated"><?php echo lang('login'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" style="--offset-top:56px; --offset-bottom:0px;">
							<div class="login" data-v-ebea41ae="">
								<div class="login-box" data-v-ebea41ae="">
									<div class="top" data-v-ebea41ae="">
									    <span class="left1" data-v-ebea41ae=""><img
												src="https://ibgoldworld.pro/h5/static/logo.png" alt=""
												data-v-ebea41ae="" style="max-width:300px;max-height:100px;margin:0 auto"></span>
												
										<span class="right1" data-v-ebea41ae="">
											<div class="qut" data-v-ebea41ae="" style="    width: 77px;">
												<div class="no-box" data-v-ebea41ae="">
													<div class="qut">
														<div
															style="font-size: 12px; color: #666; vertical-align: middle;">
    ...
    <!--        <li style="list-style: none;" data-val="zh-ry"><?php echo lang('ry'); ?></li>-->
    <!--        <li style="list-style: none;" data-val="zh-ty"><?php echo lang('ty'); ?></li>-->
    ...
    <!--    </ul>-->
											...
											<p class="title" data-v-ebea41ae="" style="font-size:16px;color:#666;margin:15px 0;font-weight:bold"><?php echo lang('login'); ?></p>
										...
										<div class="input" data-v-ebea41ae="">
											<ion-input modelvalue=""
												...
												data-v-ebea41ae=""><input class="native-input sc-ion-input-md"
													...
													name="username" placeholder="<?php echo lang('username'); ?>" required=""
									...
									<button style="position: relative;top: 35px;background: linear-gradient(90deg,#00527a,#00537f);color: #fff;padding: 10px 50px;width:100%;border-radius: 6px;" onclick="return checkform(this.form);" class="md button button-block button-solid ion-activatable ion-focusable hydrated" data-v-ebea41ae="" expand="block" style="margin-top: 35px;"><?php echo lang('login'); ?></button>
									</form>
								</div>
								<div data-v-ebea41ae="" style="text-align:center;color:#000;margin-top:50px;font-size:14px"><span data-v-ebea41ae=""
													style="margin-right: 5px;"></span><span class="a"
													data-v-ebea41ae=""><a href="<?php echo url('login/register'); ?>" style="color:red"><?php echo lang('myzh'); ?> <?php echo lang('register'); ?></a></span></div>
							</div>
						</ion-content>
					</div>
				</ion-router-outlet>
    ...
    function checkform(form) {
        ...
        console.log(data,formurl,locurl,7777)
