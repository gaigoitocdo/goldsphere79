<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"/www/wwwroot/isetradingstar.com/application/lord/view/system/adminlist.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747522164;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1690047148;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <tbody>
                            <!-- <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td><?php if($vo['otype'] == 1): ?>Quản trị viên hệ thống<?php elseif($vo['otype'] == 3): ?>Nhân viên hỗ trợ<?php endif; ?></td>
