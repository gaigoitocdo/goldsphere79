<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/www/wwwroot/isetradingstar.com/application/lord/view/system/addproscale.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747522285;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1690047148;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<!-- 
            ...
            <li <?php if($contrname == 'Chat'): ?> class="active" <?php else: ?> class="sub-menu" <?php endif; ?>>
                  ...
                  <div class="col-sm-12">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1> Thêm cấu hình tỷ lệ lợi nhuận</h1>
                              <form class="form-horizontal" role="form" method="post" id="formid">

                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Thời gian bắt đầu</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" id="start_time" placeholder="HH:mm:ss" name="start_time"  value="<?php echo !empty($rs['start_time'])?$rs['start_time']:''; ?>"  >
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-lg-2 control-label">Thời gian kết thúc</label>
                                      <div class="col-lg-6">
                                         <input type="text" class="form-control" id="end_time" placeholder="HH:mm:ss" name="end_time"  value="<?php echo !empty($rs['end_time'])?$rs['end_time']:''; ?>"  >
                                         <div class="alert alert-block alert-danger fade in" style="margin:10px 0 0 0 ">
                                               <strong>Lưu ý: </strong> Khi không nhập cả thời gian bắt đầu và kết thúc, tỷ lệ lợi nhuận sẽ được thiết lập là mặc định của hệ thống.
                                        </div>
                                      </div>
                                 ...
                                 <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                          <input type="text" class="form-control" value="<?php echo !empty($rs['proscale'])?$rs['proscale']:''; ?>"  placeholder="Vui lòng nhập Tỷ lệ lợi nhuận" name="proscale">
                                          <div class="alert alert-block alert-danger fade in" style="margin:10px 0 0 0 ">
                                  ...
                                  <?php if(isset($rs['id']) && !empty($rs['id'])): ?>
...
<script>
  function editcon(form){
    ...
    if((!start_time && end_time) || (start_time && !end_time)){layer.msg('Thời gian bắt đầu và kết thúc, bạn phải nhập cả hai hoặc không nhập cùng lúc, không thể chỉ nhập một trong hai'); return false;}
    if(!proscale){layer.msg('Vui lòng nhập thông tin tỷ lệ lợi nhuận/ tỷ lệ lỗ'); return false;}

    var formurl = "<?php echo Url('system/addproscale'); ?>";
    var data = $('#formid').serialize();
    var locurl = "<?php echo Url('system/proscale'); ?>";
