<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/goldsphere79.com/application/index/view/user/index.html";i:1755884994;}*/ ?>
<!DOCTYPE html>
...
.btn-right {margin-left:auto;color:#303133}
.btn-right{color:#303133;fill:#fff;display:flex;color:#606266;font-size:14px;align-items:center}
.nav .nav-box{margin-top:0!important}
		</style>
		<style>
			ion-list {
				margin-left: 0;
...
.header {
    display: flex;
    flex-direction: column;
    background: url(/static/images/user_bg3.png) no-repeat;
...
.header .header-box .my-h-top {background:none;color:#fff;font-size:16px;line-height:1.6}
.header .header-box .my-h-top p.name{font-size:17px;font-weight:bold;margin:15px 0 5px}
.header-btn {display:flex;justify-content:space-between;max-width: 80%;margin: 10px auto}
.header-btn a{display:block;width:100px;background:linear-gradient(to right, rgb(0, 173, 127), rgb(59, 186, 192));color:#fff;font-size:13px;padding:5px 10px;line-height:1.6;border-radius:5px}
.level{background:linear-gradient(90deg, #f56c6c, #de6161);border-radius:5px;padding:3px;font-size:11px}
		</style>
	</head>
	<body id="body">
		<div id="app" data-v-app="">
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
					<div class="ion-page" id="tabs-ion-page" style="z-index: 99;background:#fff">
										...
										<ion-content class="md hydrated"
												...
												<div class="header-box">
													<div class="my-h-top">
																	<ion-avatar class="md hydrated"
																		style="margin: auto;padding-bottom:10px"><img
																			src="/static/index/user/avatar.e203b0b7.png">
																	</ion-avatar>
																	<p class="name"><?php echo !empty($userinfo['username'])?$userinfo['nickname']:$userinfo['username']; ?>
																	<span class="level">VIP <?php echo $userinfo['level']; ?></span>
																	</p>
																	<p><?php echo lang('ye'); ?><?php echo lang('dw'); ?><?php echo $userinfo['usermoney']; ?>
																	</p>
																	<p style="color:#eee;font-size:85%"><?php echo lang('tjm'); ?>: <?php echo $userinfo['uid']; ?>
																	</p>
																	
													<div class="header-btn">
													    <a onclick="show_cz()"><?php echo lang('chongzhi'); ?></a>
													    <a onclick="show_tx()"><?php echo lang('tx'); ?></a>
													</div>
													</div>
												</div>
											</div>
											...
											<div style="color:#303133">
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img
																	src="/static/images/bank.png" alt="">
															</div>
															<div style="color:#303133" class="nav-box"><?php echo lang('chongzhijl'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
															</a>
													</ion-col>
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img
																	src="/static/images/wallet.png" alt="">
															</div>
															<div style="color:#303133" class="nav-box"><?php echo lang('tixianjl'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
															</a>
													</ion-col>
													...
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img src="/static/index/user/assets.4eda1e5b.svg"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('jyls'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img
																	src="/static/images/icon_user_5.511f0cc1.png" alt="">
															</div>
															<div style="color:#303133" class="nav-box"><?php echo lang('shoukuanfs'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img src="/static/images/icon_user_10.safe.png"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('xiugaimima'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img src="/static/images/plistico3.png"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('xgtxmm'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated"
														style="flex: 0 0 calc(calc(3 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(3 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(3 / var(--ion-grid-columns, 12)) * 100%);">
														<a href="<?php echo Url('/index/chat/index/token/'.$token); ?>">
														<div class="col-th">
															<div class="icon"><img src="https://cdn-icons-png.freepik.com/512/8696/8696643.png"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('kf'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img src="/static/images/icon_my_announcement@2x.png"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('pingtaigg'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated langtarger"
														style="flex: 0 0 calc(calc(3 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(3 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(3 / var(--ion-grid-columns, 12)) * 100%);">
														<a href="javascript:;">
														<div class="col-th">
															<div class="icon"><img src="/static/images/icon_user_10.6d36f5a0.png"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('ywjc'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <span id="langtarger" style="line-height: 10px;">
																						  <?php echo lang('yuyan'); ?></span><svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img src="/static/images/icon_my_pull_out@2x.png"
																	alt=""></div>
															<div style="color:#303133" class="nav-box"><?php echo lang('tc'); ?></div>
															<div data-v-19622b17="" class="btn-right"> <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg></div>
														</div>
														</a>
													</ion-col>
													...
													<ion-col class="md hydrated"
														...
														<div class="col-th-line">
															...
															<div class="col-right">
																<ion-icon role="img" class="md hydrated">
																     <svg   xmlns="http://www.w3.org/2000/svg"   width="24"   height="24"   viewBox="0 0 24 24"   fill="none"   stroke="#cecece"   stroke-width="1"   stroke-linecap="round"   stroke-linejoin="round" >   <path d="M9 6l6 6l-6 6" /> </svg>
																</ion-icon>
															</div>
														</div>
														</a>
...
.on[data-v-28ad7794] {
    color: rgb(45, 122, 197);
		...
		<div data-v-28ad7794="" data-v-0c912c96="" class="box" id="oukes">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" data-href="<?php echo url('/index/project/index'); ?>" href="<?php echo Url('/index/project/index/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="/static/images/order.png" alt="">
                    <span data-v-28ad7794="" class="in"><?php echo lang('da'); ?></span>
                </a>
            </div>
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" href="<?php echo Url('/index/user/index/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="/static/images/user_active.png" alt="">
                        		...
                        		<div class="modal-box" data-v-4d5fa6e4="" style="margin:auto;">
                        			...
                        			<div data-v-4d5fa6e4="">
                        			  <div class="rechargeInput" data-v-4d5fa6e4="" style="margin: 15px 0px;">
                        			       <select name='type' class='sc-ion-input-md-h sc-ion-input-md-s md hydrated' style="color: #ccc;background: #000; border: 1px solid #3d3939;border-radius:3px;padding:5px!important;margin-bottom:5px">
		...
		<div class="withdraw-box modal-box" data-v-19622b17="" style="margin:auto;background:#141414">
			<ion-card class="md hydrated" data-v-19622b17="">
				...
				<ion-card-content class="md card-content-md hydrated" data-v-19622b17="">
					<div data-v-19622b17="" style="font-size:14px;text-align:left">
    ...
    border-bottom: 1px solid #ffe2ad;">
							<ion-label class="sc-ion-label-md-h sc-ion-label-md-s md hydrated" data-v-19622b17=""
								id="ion-input-11-lbl" style="width:36%"><?php echo lang('txje'); ?></ion-label>
							<ion-input modelvalue=""  class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"  style="width:64%"
    ...
    border-bottom: 1px solid #ffe2ad;"
							data-v-19622b17="">
							<ion-label class="sc-ion-label-md-h sc-ion-label-md-s md hydrated" data-v-19622b17=""
								id="ion-input-12-lbl" style="width:36%"><?php echo lang('txmm'); ?></ion-label>
							<ion-input modelvalue=""
								class="input-password sc-ion-input-md-h sc-ion-input-md-s md hydrated" style="width:64%"
								onpaste="return false" data-v-19622b17=""><input class="native-input " style="background:#141414;border:1px solid #141414"
						...
						<ion-button class="md button button-block button-solid ion-activatable ion-focusable hydrated bd"
							data-v-19622b17="" expand="block" style="margin-top: 10px;margin-bottom: 15px;   " onclick="bk3()" ><?php echo lang('tixianjiami'); ?> (<?php echo $user['usdt']; ?>)</ion-button>
							<?php endif; if(($user['bank'])): ?>
						<ion-button class="md button button-block button-solid ion-activatable ion-focusable hydrated bd"
							data-v-19622b17="" expand="block" style="margin-top: 10px;margin-bottom: 15px;   " onclick="bk2()" ><?php echo lang('tixianyinhang'); ?> (<?php echo $user['bank']; ?>)
							<br/>
							<small><?php echo $user['rname']; ?> - <?php echo $user['account']; ?></small>
							</ion-button>
							<?php endif; else: ?>
							<ion-button class="md button button-block button-solid ion-activatable ion-focusable hydrated bd"
		...
		<ul class="langselect" style="display: none;border: 1px solid #424242;padding: 5px;background: #141414;position: fixed;top: 10px;left: 50%;  transform:translateX(-50%);width: 80%;color: white;max-width:450px;z-index:99999999999">
            ...
            <li class="xzmb input-radio" style="list-style: none;padding: 10px 16px;border-bottom: 1px solid #404040;"><label><span style="display:inline-block;width:90%"><?php echo lang('cn'); ?></span><input type="radio" name="yuyan" value="zh-cn"></label></li>-->
                                                                                     <li id="langselect5" style="list-style: none;padding:0 16px;margin-top: 20px;"><button style="padding: 10px;width: 100%;background: linear-gradient(to right, rgb(0, 173, 127), rgb(59, 186, 192));border-radius: 5px;" type="submit"><?php echo lang('qiehuan'); ?></button></li>
    ...
    $('#langtarger, .langtarger').click(function (e) {
        e.stopPropagation()
...
function out_withdraw() {
    ...
    function go_step2() {
        var paytype = $('.rechargeInput option:selected').val();
        var userid = $('#myid').val();
