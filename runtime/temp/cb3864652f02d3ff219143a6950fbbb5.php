<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/51.79.209.207/application/index/view/user/cpassword.html";i:1755612851;}*/ ?>
<!DOCTYPE html>
...
<html lang="en" mode="md" class="plt-desktop md hydrated">
	<head>
		...
		<title><?php echo lang('xgdlmm'); ?></title>
...
.native-input.sc-ion-input-md, .r-input {
    background: #fff;
}
input {
...
input::placeholder {
				...
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
					<div class="" style="z-index: 101;">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner">
							<!---->
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display: flex;align-items: center;padding: 10px 20px;background:linear-gradient(90deg,#00527a,#00537f)">
								...
								<ion-title class="md title-default hydrated"><?php echo lang('xgdlmm'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" style="--offset-top:56px; --offset-bottom:0px;">
							<div class="repwd-box">
								<div class="text-header" style='color:#000'><?php echo lang('mmts'); ?></div>
									...
									<div class="r-input">
										<ion-input modelvalue=""
											...
											<input class="native-input sc-ion-input-md"
												...
												placeholder="<?php echo lang('srxmm'); ?>" spellcheck="false" type="text"></ion-input>
									</div>
									...
									<div class="r-input">
										<ion-input modelvalue=""
											...
											<input class="native-input sc-ion-input-md"
												...
												placeholder="<?php echo lang('zcsrxmm'); ?>" spellcheck="false" type="text"></ion-input>
									</div>
								</div>
								<button class="md button button-block button-solid ion-activatable ion-focusable hydrated" expand="block" style="margin-top: 40px;width: 100%;background: linear-gradient(to right, rgb(0, 173, 127), rgb(59, 186, 192));padding: 12px;border-radius: 5px;color:#fff" onclick="checkform2();"><?php echo lang('qrxg'); ?></button>
	...
	function checkform2(){
        ...
        $.post('/index/user/cpassword',{'nickname':nickname,'upwd':upwd,'upwd2':upwd2},function(data){
            if(data.type==1){
