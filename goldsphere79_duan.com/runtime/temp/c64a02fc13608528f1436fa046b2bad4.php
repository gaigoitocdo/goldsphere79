<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/wwwroot/goldsphere79.com/application/index/view/user/paymode.html";i:1755612854;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0030)/payMode -->
<html lang="en" mode="md" class="plt-android plt-phablet plt-mobile plt-mobileweb md hydrated">
	<head>
		...
		<title><?php echo lang('shoukuanfs'); ?></title>
		...
		<link href="./paymode_files/text-security-disc.css" rel="stylesheet" type="text/css">
			...
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
					<div class="" style="z-index: 99;">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner" style="background:linear-gradient(90deg,#00527a,#00537f)">
							<!---->
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display:flex;padding:10px 5px">
								<ion-buttons onclick="window.history.go(-1)"
									class="buttons-first-slot sc-ion-buttons-md-h sc-ion-buttons-md-s md hydrated"
									slot="start" style="    float: left;margin-left:10px;">
								<img src="/static/index/zzt1.png"  width="24px;"/>
								</ion-buttons>
								<ion-title class="md title-default hydrated" style="    color: #fff;float:left;margin-left:10px;font-size:18px;line-height:30px"><?php echo lang('shoukuanfs'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
							...
							<div class="notice-box" >
								<ion-list class="md list-md list-lines-none list-md-lines-none hydrated">
									<ion-item class="item md item-lines-none in-list ion-focusable hydrated">
									    <a href="<?php echo url('yhk'); ?>">
										<div class="notice-list-box" style="    display: flow-root;">
											<ion-row class="md hydrated">
											    
												<ion-col class="md hydrated" style="float: left;"
													...
													<p class="list-img"><img src="/static/index/bankcard.b9fc04a2.svg"
															alt=""></p>
												</ion-col>
												...
												<ion-col class="md hydrated" style="float: right;"
									...
									<ion-item class="item md item-lines-none in-list ion-focusable hydrated">
									    <a href="<?php echo url('cryptocurrency'); ?>">
										<div class="notice-list-box" style="    display: flow-root;">
											<ion-row class="md hydrated">
												<ion-col class="md hydrated"  style="float: left;"
													style="flex: 0 0 calc(calc(2 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(2 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(2 / var(--ion-grid-columns, 12)) * 100%);">
													<p class="list-img"><img src="/static/index/btc.f126b01e.svg"
															alt=""></p>
												</ion-col>
												<ion-col class="md hydrated"  style="float: left;"
													style="flex: 0 0 calc(calc(7.5 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(7.5 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(7.5 / var(--ion-grid-columns, 12)) * 100%);">
