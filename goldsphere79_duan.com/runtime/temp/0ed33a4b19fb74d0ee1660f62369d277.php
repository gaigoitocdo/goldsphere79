<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/goldsphere79.com/application/index/view/chat/index.html";i:1755723387;}*/ ?>
<!DOCTYPE html>
<html>
...
<body style="background: #fff; font-size: 16px;padding: 15px;box-sizing:border-box">
    <style>
        .chat-container {
            max-width: 500px;
            margin: auto;
...
<div class="chat-container">
    <div class="chat-header">Chat CSKH</div>
    <div class="chat-box" id="chat-box"></div>
    <div class="chat-input">
        <button class="icon-button" onclick="document.getElementById('image-input').click()">
            <i class="fas fa-image"></i>
        </button>
        <!--<button class="icon-button" onclick="sendIcon('😊')">
...
<script>
    ...
    function loadNewMessages() {
        $.post("<?php echo url('index/Chat/getNewMessages'); ?>", {
    ...
    function sendMessage() {
        ...
        var type = image ? 'image' : (text === '😊' ? 'icon' : (text ? 'text' : null));
        if (!type) return;
        ...
        $.ajax({
            url: "<?php echo url('index/Chat/sendMessage'); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
<div id="app" style="height: 100%;position: fixed;width: 100%; max-width: 600px;position: fixed;height: 90%">
    <div class="box1" style="height:100%">
        <div class="box tiver powershe"  id="tes06" style="height:100%">
             <iframe width="100%" id="holid" height="100%" src="https://tawk.to/chat/64bcd89c94cf5d49dc65db2e/1h60qs912" frameborder="0"></iframe>
        </div>
	
    <div data-v-0c912c96="" style="margin-bottom: 50px;" class=""></div>
		<div data-v-28ad7794="" data-v-0c912c96="" class="box" id="oukes">
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" href="<?php echo Url('/index/index'); ?>" class="li">
                    <img data-v-28ad7794="" src="https://ibgoldworld.pro/h5/static/images/market.png" alt="">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" data-href="<?php echo url('/index/index/kefu?id=9'); ?>" href="<?php echo Url('/index/chat/index'); ?>" class="li">
                    <img data-v-28ad7794="" src="https://ibgoldworld.pro/h5/static/images/order_active.png" alt="">
                    <span data-v-28ad7794="" class="on"><?php echo lang('kf'); ?></span>
                    <div class="unread-count" id="unread-count">0</div>
                    <style>.unread-count{position:absolute;background:red;color:#303133;border-radius:100%;width:15px;height:15px;display:flex;align-items:center;justify-content:center;font-size:11px;margin-right:-30px;margin-top:-30px}</style>
                </a>
            </div>
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
