<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/51.79.188.227/hosetrade/application/index/view/user/asset.html";i:1694961976;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0028)/asset -->
<html lang="en" mode="md" class="plt-desktop md hydrated">
    ...
    width: 100%;
		...
		<style>body {font-family:Arial;width:100%;max-width: 1600px;margin: 0 auto;position:relative}.box #nav[data-v-12171d70]{width:100%!important;max-width: 1600px!important}.box[data-v-28ad7794]{max-width: 1600px!important;transform: translateX(-50%);left:50%!important}*{max-width:100%}*::-webkit-scrollbar{display:none}ion-avatar img{max-width:80px}</style>
	</head>
	<body id="body" class="">
		<div id="app" data-v-app="" style="color:#fff">
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">0.99388</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">0.8569</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.63953</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">7.2514</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">1.35906</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">147.872</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.99521</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.57905</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">171.60546
																			</div>
																		</div>
																	</ion-col>
																</ion-row>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.80424</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.15826</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
					...
					<div class="ion-page can-go-back" data-v-8aae1df6="" style="z-index: 101;position: inherit;contain: content;">
						<ion-header class="md header-md header-collapse-none hydrated" data-v-8aae1df6="" role="banner">
							...
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" data-v-8aae1df6="" style="display: flex;align-items: center;padding: 10px 20px;">
								<ion-buttons onclick="javascript:history.back(-1)" style="margin-right: 6px;width: 34px;"
								...
								<ion-title class="md title-default hydrated" data-v-8aae1df6=""><?php echo lang('gerenzichan'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" data-v-8aae1df6=""
							style="--offset-top:56px; --offset-bottom:0px;">
							<div class="header">
												<div class="header-box">
													<div class="my-h-top">
														<ion-row class="md hydrated">
															...
															<ion-col class="md hydrated"
																...
																<div class="t-center">
																	...
																	<p><?php echo lang('ye'); ?><span
																			style="font-size: 10px; line-height: 12px;"><?php echo lang('dw'); ?><?php echo $userinfo['usermoney']; ?></span>
																	</p>
																</div>
															</ion-col>
															<!--<ion-col class="md hydrated"-->
																			...
																			<div class="qut">
																				<div
																					...
																					<span style="display: none;"><img
																							src="/static/index/user/cny.350cf10d.svg"
																							alt=""
																							style="width: 30px; margin-bottom: -10px;"></span><p style="margin-left: 0%;margin-top:0px;color:#ff9800;">
                    ...
                    <?php echo lang('xyf'); ?>：<meter min="0" max="100" value="<?php echo $userinfo['userpoint']; ?>" low="80" high="90" ></meter><?php echo $userinfo['userpoint']; ?>
															...
															<ion-col class="md hydrated">
																<div class="b-right">
																	...
																	<div class="to">
																	    <a href="<?php echo url('/index/order/hold'); ?>"><span
																			style="line-height: 10px;"><?php echo lang('ckjqjy'); ?></span></a>
																			<span
																			style="font-size: 10px; line-height: 12px;">
																			<ion-icon role="img" class="md hydrated">
																			</ion-icon>
							...
							<div class="no-box" data-v-419b8d62="" data-v-8aae1df6="">
								<p class="text" data-v-419b8d62=""></p>
							</div>
							<div class="asset-data" data-v-8aae1df6="">
								<ion-row class="md hydrated" data-v-8aae1df6="">
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="">
										<div class="label" data-v-8aae1df6=""><?php echo lang('yhm'); ?></div>
										<div class="title" data-v-8aae1df6=""><?php echo !empty($userinfo['username'])?$userinfo['nickname']:$userinfo['username']; ?></div>
									</ion-col>
								</ion-row>
								<ion-row class="md hydrated" data-v-8aae1df6="" style="display: flex;">
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="flex: 0 0 calc(calc(7 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(7 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(7 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="label" data-v-8aae1df6=""><?php echo lang('ye'); ?></div>
										<div style="font-size: 26px;" class="money" data-v-8aae1df6=""><?php echo lang('dw'); ?><?php echo $userinfo['usermoney']; ?></div>
									</ion-col>
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="flex: 0 0 calc(calc(3.5 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(3.5 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(3.5 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="icon" data-v-8aae1df6="">USD</div>
									</ion-col>
								</ion-row>
								<ion-row class="md hydrated" data-v-8aae1df6="">
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="display: none; flex: 0 0 calc(calc(12 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(12 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(12 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="label" data-v-8aae1df6="">冻结金额</div>
										<div class="centertext" data-v-8aae1df6="">0</div>
									</ion-col>
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="flex: 0 0 calc(calc(12 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(12 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(12 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="label" data-v-8aae1df6=""><?php echo lang('xyf'); ?><ion-icon data-v-8aae1df6="" role="img"
												class="md hydrated" style="font-size: 8px;"></ion-icon>
										</div>
										<div class="centertext" data-v-8aae1df6=""><?php echo $userinfo['userpoint']; ?></div>
									</ion-col>
								</ion-row>
								<ion-row class="md hydrated" data-v-8aae1df6="">
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="flex: 0 0 calc(calc(8 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(8 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(8 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="label" data-v-8aae1df6=""><?php echo lang('zyk'); ?></div>
										<div class="price c-r" data-v-8aae1df6=""><?php echo $today_income; ?></div>
									</ion-col>
								</ion-row>
								<ion-row class="md hydrated" data-v-8aae1df6="">
									...
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="label" data-v-8aae1df6=""><?php echo lang('zzc'); ?></div>
										<div class="mintext" data-v-8aae1df6=""><?php echo $out_price; ?></div>
									</ion-col>
									<ion-col class="md hydrated" data-v-8aae1df6=""
										style="flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="label" data-v-8aae1df6=""><?php echo lang('zhb'); ?></div>
										<div class="mintext" data-v-8aae1df6=""><?php echo $income_price; ?></div>
									</ion-col>
									</div>
									<!--<div style="display:flex">-->
									<!--<ion-col class="md hydrated" data-v-8aae1df6=""-->
									<!--	style="flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">-->
									<!--	<div class="label" data-v-8aae1df6="">最高支出</div>-->
									<!--	<div class="mintext" data-v-8aae1df6="">0</div>-->
									<!--</ion-col>-->
									<!--<ion-col class="md hydrated" data-v-8aae1df6=""-->
									<!--	style="flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">-->
									<!--	<div class="label" data-v-8aae1df6="">最高收益</div>-->
									<!--	<div class="mintext" data-v-8aae1df6="">0</div>-->
									<!--</ion-col>-->
									<!--</div>-->
								</ion-row>
