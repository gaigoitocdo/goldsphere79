<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/www/wwwroot/goldsphere79.com/application/lord/view/user/userprice.html";i:1690248718;s:61:"/www/wwwroot/goldsphere79.com/application/lord/view/head.html";i:1690248718;s:61:"/www/wwwroot/goldsphere79.com/application/lord/view/menu.html";i:1755730339;s:61:"/www/wwwroot/goldsphere79.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<!--main content start-->
      <section id="main-content">
          <section class="wrapper">
                ...
                <div class="row">
                      <form action="" method="get">
                            <?php if($otype == 3): ?>
                             ...
                             <?php else: ?>
								   <input type="hidden" value="<?php echo !empty($getdata['username'])?$getdata['username']:''; ?>"  class="form-control" name="username" />
                             <?php endif; ?>
                      ...
                      <div class="col-lg-3 mar-10">
                        <div class="input-group">
                            ...
                            <select name="bptype"  class="selectpicker show-tick form-control">
                                ...
                                <option <?php if(isset($getdata['bptype']) && $getdata['bptype'] == 1): ?> selected="selected" <?php endif; ?> value="1">Người dùng nạp tiền</option>
                                <option <?php if(isset($getdata['bptype']) && $getdata['bptype'] == 2): ?> selected="selected" <?php endif; ?> value="2">Nạp tiền từ trang quản trị</option>
                            </select>
                        </div>
                      </div>
            ...
            <a href="<?php echo url('user/userprice'); ?>"><button type="submit" class="btn btn-danger">Tìm kiếm tất cả</button></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;"><button type="submit" class="btn btn-danger">Tổng số tiền nạp: <?php echo $all_bpprice; ?></button></a>&nbsp;&nbsp;&nbsp;&nbsp;
                          ...
                          <!-- <?php if(is_array($balance) || $balance instanceof \think\Collection || $balance instanceof \think\Paginator): $i = 0; $__LIST__ = $balance;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td><?php if($vo['bptype'] == 1): ?>
                                      ...
                                      <?php elseif($vo['bptype'] == 2 && $vo['isverified'] == 0 && $otype == 3): ?>
                                      <button class="btn btn-primary btn-xs price" data-toggle="modal" data-bpid="<?php echo $vo['bpid']; ?>" data-userid="<?php echo $vo['uid']; ?>" data-target="#myModal">Xử lý / Từ chối</button>
                                      <?php elseif($vo['bptype'] == 2 && $vo['isverified'] == 2): ?>
...
var jujue =2;
    ...
    $('.jujue').click(function(){
    	...
    	var formurl = "<?php echo Url('user/dochongzhi'); ?>";
