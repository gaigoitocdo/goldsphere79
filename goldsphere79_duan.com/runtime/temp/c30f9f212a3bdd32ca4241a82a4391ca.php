<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/goldsphere79.com/application/index/view/order/hold.html";i:1755810205;}*/ ?>
...
<div data-v-45ed8902="" class="mybox">
		...
		<div data-v-28ad7794="" data-v-0c912c96="" class="box" id="oukes">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" href="<?php echo Url('/index/order/hold/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="/static/images/trading_active.png" alt="">
    ...
    <!--    <div data-v-28ad7794="" style="flex: 1 1 0%; background:#fff"><a data-v-28ad7794=""-->
    ...
    <!--    <div data-v-28ad7794="" style="flex: 1 1 0%; background:#fff"><a data-v-28ad7794="" href="<?php echo Url('/index/order/lixibao/token/'.$token); ?>"-->
    <!--                                                     class="li"><img data-v-28ad7794="" src="/tu/ico/lc.png" alt="">-->
    <!--        <span data-v-28ad7794="" class="in"><?php echo lang('lc'); ?></span></a></div>-->
    <!--    <div data-v-28ad7794="" style="flex: 1 1 0%; background:#fff"><a data-v-28ad7794="" href="javascript:void(0)"-->
    ...
    <ion-nav-bar class="bar-stable headerbar nav-bar-container" nav-bar-transition="ios" nav-bar-direction="swap"
                 nav-swipe="" style="background: #fff;">
            ...
            <ion-nav-view name="tab-history" class="view-container tab-content" nav-view="active"
                ...
                <ion-view view-title="" hide-nav-bar="false" class="pane" state="tab.history" nav-view="active"
                    ...
                    <ion-content
                            ...
                            scroll="false" style="background: #fff;bottom:0">
                        <header style="background: #fff; border-top: 0">
                            ...
                            <div class="modal-backdrop ng-hide">
                                ...
                                <div class="modal-wrapper" ng-transclude="">
                                    <ion-modal-view
                                        ...
                                        <ion-header-bar class="order-modal-header bar bar-header" style="background:#fff">
                                        ...
                                        <ion-content
                                                class="order-modal-content scroll-content ionic-scroll  has-header" style="background: #fff">
                                            <div class="scroll"
                                                 style="transform: translate3d(0px, 0px, 0px) scale(1); background: #fff">
                                                <ul class="list" style="margin-top:40px; background: #fff;" >
