<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/isetradingstar.com/application/lord/view/goods/prolist.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="col-lg-8">
                      <section class="panel">
                          <header class="panel-heading">
                              <h4 class="left">Danh sách sản phẩm</h4>
                              <a href="<?php echo url('goods/proadd'); ?>"><button type="button" class="btn btn-primary right">Thêm sản phẩm</button></a>
                              <br><br>
                          </header>
                          <table class="table table-striped table-advance table-hover">
                            <thead class="ordertable">
                              <tr>
                                ...
                                <th>
                                    Trạng thái（Trong giờ mở cửa của thị trường）
                                </th>
                                <th>
                                    Danh mục
                                </th>
                                ...
                                <th>
                                    Giá trị tối thiểu kiểm soát rủi ro
                                </th>
                                <th>
                                    Giá trị tối đa kiểm soát rủi ro
                                </th>
                                <th>
                                    Thao tác
                                </th>
                          ...
                          <!-- <?php if(is_array($proinfo) || $proinfo instanceof \think\Collection || $proinfo instanceof \think\Paginator): $i = 0; $__LIST__ = $proinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td><?php if($vo['isopen'] == 1): ?> Mở cửa <?php else: ?> Đóng cửa <?php endif; ?></td>
                                  ...
                                  <td>
                                  <?php if($vo['isopen'] == 1): ?>
                                    <a class="btn btn-danger btn-xs" onclick="isopen(0,<?php echo $vo['pid']; ?>)">Nhấp để tạm dừng</a>
                                  <?php else: ?>
                                  	<a class="btn btn-success btn-xs" onclick="isopen(1,<?php echo $vo['pid']; ?>)">Nhấp để mở lại</a>
                                  <?php endif; ?>
                                      <a class="btn btn-primary btn-xs" href="<?php echo url('goods/proadd',array('pid'=>$vo['pid'])); ?>" title="Nhấp để chỉnh sửa"><i class="icon-pencil"></i></a>
                                      <a class="btn btn-danger btn-xs" onclick="deleteinfo('<?php echo $vo['pid']; ?>')" title="Nhấp để xóa"><i class="icon-trash"></i></a>
                                  </td>
                              </tr>
                          ...
                          <button type="submit" class="btn btn-primary left">Sắp xếp</button>
                            </form>
                  </div>
              </div>
