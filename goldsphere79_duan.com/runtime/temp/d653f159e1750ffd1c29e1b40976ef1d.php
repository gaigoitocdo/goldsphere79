<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"/www/wwwroot/51.79.209.207/application/index/view/index/kefu.html";i:1755612849;}*/ ?>
<!DOCTYPE html>
<html>
...
<style>
    ...
    <style type="text/css">
        ...
        .Currency .login .btn[data-v-76b6b367] {
    		...
    		<style>body {font-family:Arial;width:100%;max-width: 600px;margin: 0 auto;position:relative}.box #nav[data-v-12171d70]{width:100%!important;max-width: 600px!important}.box[data-v-28ad7794]{max-width: 600px!important;transform: translateX(-50%);left:50%!important}*{max-width:100%}*::-webkit-scrollbar{display:none}</style>
</head>
...
<script>
        ...
        var pmht =$("#app").height()-45;
        var isd = "<?php echo $id; ?>";
        //alert(isd)
        if(isd!=0){
            window.location = '/index/index/kefu';
        }
        //$('#tes06').css({'height': pmht+'px'})
        console.log(isIOS);
        if (isAndroid) {
          $('#tes06').css({'height': pmht+'px'})
        }
