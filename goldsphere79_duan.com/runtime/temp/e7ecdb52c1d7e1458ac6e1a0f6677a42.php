<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/51.79.209.207/application/index/view/user/cashlist.html";i:1755612850;}*/ ?>
...
<head>
    ...
    <title><?php echo lang('tixianjl'); ?></title>
        ...
        <ion-nav-view class="view-container" nav-view-transition="ios" nav-view-direction="none" nav-swipe="">
            <ion-tabs class="tabs-icon-top navbar pane tabs-bottom tabs-standard" abstract="true" nav-view="active"
                ...
                <ion-nav-bar class="bar-stable headerbar nav-bar-container" nav-bar-transition="ios"
                             nav-bar-direction="swap" nav-swipe="">

                    <div class="nav-bar-block" nav-bar="active">
                        <ion-header-bar onclick="javascript:history.back(-1)" class="bar-stable headerbar bar bar-header" align-title="center"  style="background:linear-gradient(90deg,#00527a,#00537f)">
                            <div class="title title-center header-item"
                                 style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);color:#fff !important;text-align: left;"><img style="width:28px;position: relative;top: 8px;margin-right: 7px;" src="/static/index/user/fhjt.png"><?php echo lang('tixianjl'); ?></div>
                        </ion-header-bar>
                    </div>
                </ion-nav-bar>
                ...
                <ion-content
                        ...
                        scroll="false" style="margin-top: 60px ;background: #fff;color:#000;bottom:0">
