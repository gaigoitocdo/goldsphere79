<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/goldsphere79.com/application/index/view/user/cryptocurrency.html";i:1755612852;}*/ ?>
<!DOCTYPE html>
...
<html lang="en" mode="md" class="plt-desktop md hydrated">
	<head>
		...
		<title><?php echo lang('ylkj'); ?></title>
					...
					<div class="" style="z-index: 101;">
						<ion-header class="md header-md header-collapse-none hydrated" data-v-8aae1df6="" role="banner" style="background:linear-gradient(90deg,#00527a,#00537f)">
							...
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" data-v-8aae1df6="" style="display: flex;align-items: center;padding: 10px 20px;">
								...
								<ion-title class="md title-default hydrated" data-v-8aae1df6=""><?php echo lang('ylkj'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
