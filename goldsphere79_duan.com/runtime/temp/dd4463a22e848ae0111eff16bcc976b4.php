<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/isetradingstar.com/application/lord/view/setup/index.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
		                ...
		                <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		                  <div class="form-group">
		                      ...
		                      <div class="col-lg-6">
		                        ...
		                        <div class="upload-pre-item"><a href="<?php echo $vo['value']; ?>" target="_block" title="Nhấp để xem ảnh lớn"><img height="100" src="<?php echo $vo['value']; ?>" alt=""></a></div><br>
								<?php endif; ?>
