<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/51.79.188.227/hosetrade/application/index/view/user/company.html";i:1694961976;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0030)/company -->
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.99396</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">0.85731</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.63988</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">7.2511</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.36028</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">147.779</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">0.99702</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">1.57851</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">171.50518
																			</div>
																		</div>
																	</ion-col>
																</ion-row>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">1.80761</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.15902</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
											...
											<div class="nav">
												<ion-row class="md hydrated">
													...
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img
																	src="/static/index/user/key.59ef0d05.svg" alt=""></div>
					...
					<div class="" style="z-index: 101;">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner">
							...
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display: flex;align-items: center;padding: 10px 20px;">
								...
								<ion-title class="md title-default hydrated"><?php echo lang('pingtaigk'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" style="--offset-top:56px; --offset-bottom:0px;">
							<div class="company-box">
								<ion-row class="md hydrated">
									...
									<ion-col class="md hydrated"
										style="overflow: hidden; flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="cbox">
											<div class="top"><span><img src="/static/index/user/clogo.e079d025.svg"
														style="width: 12px;"></span> <span><?php echo lang('gsqc'); ?></span></div>
											<div class="cbottom">Mini Trade Markets</div>
										</div>
									</ion-col>
									<ion-col class="md hydrated"
										style="flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="cbox cright">
											<div class="top"><span><img src="/static/index/user/clogo.e079d025.svg"
														style="width: 12px;"></span> <span><?php echo lang('jzzt'); ?></span></div>
											<div class="cbottom">FSA/CySEC/FCA</div>
										</div>
									</ion-col>
									</div>
									<div style="display:flex">
									<ion-col class="md hydrated"
										...
										<div class="cbox cright">
											<div class="top"><span><img src="/static/index/user/clogo.e079d025.svg"
														style="width: 12px;"></span> <span><?php echo lang('ywjc'); ?></span></div>
											<div class="cbottom">MT FXTM</div>
										</div>
									</ion-col>
									<ion-col class="md hydrated"
										style="flex: 0 0 calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(6 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="cbox">
											<div class="top"><span><img src="/static/index/user/clogo.e079d025.svg"
														style="width: 12px;"></span> <span><?php echo lang('zcgj'); ?></span></div>
											<div class="cbottom">Cyprus</div>
										</div>
									</ion-col>
									</div>
									<ion-col class="md hydrated"
										...
										<div class="cbox cright">
											<div class="top"><span><img src="/static/index/user/clogo.e079d025.svg"
														style="width: 12px;"></span> <span><?php echo lang('xgwj'); ?></span></div>
											<div class="cbottom">MT -20201010</div>
										</div>
									</ion-col>
									<ion-col class="md hydrated"
										style="flex: 0 0 calc(calc(12 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(12 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(12 / var(--ion-grid-columns, 12)) * 100%);">
										<div class="cbox">
											<div class="top"><span><img src="/static/index/user/clogo.e079d025.svg"
														style="width: 12px;"></span> <span><?php echo lang('ywwz'); ?></span></div>
											<div class="cbottom b">-</div>
										</div>
									</ion-col>
								</ion-row>
							</div>
