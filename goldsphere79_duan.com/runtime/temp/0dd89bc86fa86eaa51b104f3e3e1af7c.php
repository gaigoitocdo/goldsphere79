<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/isetradingstar.com/application/lord/view/system/proscale.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                  ...
                  <div class="col-sm-12">
                      <section class="panel">
                          <header class="panel-heading">
                              <h4 class="left">Tỷ lệ quản lý lợi nhuận (nhân viên không có kỹ thuật được khuyên không nên sửa đổi)</h4> 
                              <a href="<?php echo url('addproscale'); ?>"><span class="btn right btn-primary">Thêm cấu hình tỷ lệ lợi nhuận+</span></a>
                              <br><br>
                          </header>
                          <table class="table">
                              <thead>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $vo['proscale']; ?></td>
                                  <td> 
                                      <a href="<?php echo url('addproscale',array('id'=>$vo['id'])); ?>"><button class="btn btn-primary btn-xs" ><i class="icon-pencil"></i></button></a>
...
<script>
   ...
   function deletepay(id){
    layer.open({
      ...
      yes: function(index){
        //do something
        var url = "<?php echo url('deleteproscale'); ?>"+"?id="+id;
        
        $.get(url,function(data){
          if (data.type == 1) {
              layer.msg(data.data, {icon: 1,time: 1000},function(){
                window.location.href="<?php echo Url('proscale'); ?>";
              }); 
