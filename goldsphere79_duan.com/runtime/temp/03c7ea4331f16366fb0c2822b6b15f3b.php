<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/goldsphere79.com/application/index/view/index/index.html";i:1755857673;}*/ ?>
<!DOCTYPE html>
<html>
...
<body style="background: #fff; font-size: 16px;">
<style>
    .tiver {
        display: none;
    }
...
.box #nav .active[data-v-12171d70] {
    ...
    border-bottom: 2px solid #3c9cff;
		...
		<style>html{background:#141414}body {min-height:100vh;font-family:Arial;width:100%;max-width: 600px;margin: 0 auto;position:relative}.box #nav[data-v-12171d70]{width:100%!important;max-width: 600px!important}.box[data-v-28ad7794]{max-width: 600px!important;transform: translateX(-50%);left:50%!important}*{max-width:100%}*::-webkit-scrollbar{display:none}.modal-wrapper{max-width: 600px}
		.box .ul .Li .right[data-v-12171d70]{text-align:right}
.ratedown{background:#f56c6c;color:#fff;padding:5px;width:45px;height:20px;font-size:11px;text-align:center;margin-left:auto;line-height:20px;border-radius:8px}
.rateup{background:#00cd96;color:#fff;padding:5px;width:45px;height:20px;font-size:11px;text-align:center;margin-left:auto;line-height:20px;border-radius:8px}
		</style>
						<ion-header class="md header-md header-collapse-none hydrated" role="banner">
							<!---->
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display: flex;align-items: center;padding: 10px 20px;background:linear-gradient(90deg,#00527a,#00537f);color:#fff;justify-content:center;text-transform:uppercase">
								...
								<ion-title class="md title-default hydrated"><?php echo lang('sy'); ?></ion-title>
		<div style="position: absolute;top:10px;right:10px;width: 150px; font-size: 13px;text-transform:capitalize">
            <div id="langtarger" class="cny" style="display:flex;align-items:center;gap:3px;justify-content:end;cursor:pointer">
                    <img src="<?php echo $yuyantp; ?>" style='width:20px'/>
...
<style>.row-2{display:grid;grid-template-columns:1fr 1fr;grid-gap:10px;padding:10px}
.boxx{display:block;background:linear-gradient(90deg,#00527a,#00537f);padding:5px;border-radius:7px;color:#fff;font-size:12px;text-align:center;cursor:pointer}.flex{display:flex;align-items:center}
</style>
<div class="row-2">
    <div>
        <a class="flex boxx" href="/index/user" style="text-align:left;padding:10px">
            <span style="font-size:16px;display:block;padding-right:10px">Trung tâm hoạt động</span>
            <span><img src="https://ibgoldworld.pro/h5/static/images/vip8.png" width="120" style="width:120px;height:auto"/></span>
        </a>
    </div>
    <div>
        <a class="boxx" href="/index/chat/" style="margin-bottom:5px">
            <i class="fa fa-headphones"></i> <span>Dịch vụ CSKH</span>
        </a>
        <a class="boxx" href="/index/user/noticedetils.html">
            <i class="fa fa-file"></i> <span>Thông tin</span>
        </a>
    </div>
</div>
<div id="app">
    <div class="box1">
        <div data-v-12171d70="" data-v-0c912c96="" class="box teso1">
            <div data-v-12171d70="" id="nav" style="background:#eee;">
            ...
            <div class="box_btn" style="background:#fff;">
                <div data-v-12171d70="" class="ul" id="show-list-div" style="background:#fff;">
                </div>
            ...
            <div class="box_btn" style="display: none; background:#fff;">
		...
		<div data-v-28ad7794="" data-v-0c912c96="" class="box" id="oukes">
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" href="<?php echo Url('/index/index/index/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="https://ibgoldworld.pro/h5/static/images/market_active.png" alt="">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" href="<?php echo Url('/index/order/hold/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="https://ibgoldworld.pro/h5/static/images/trading.png" alt="">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" data-href="<?php echo url('/index/project/index'); ?>" href="<?php echo Url('/index/project/index/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="https://ibgoldworld.pro/h5/static/images/order.png" alt="">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: #fff">
                <a data-v-28ad7794="" href="<?php echo Url('/index/user/index/token/'.$token); ?>" class="li">
                    <img data-v-28ad7794="" src="https://ibgoldworld.pro/h5/static/images/user.png" alt="">
                    <span data-v-28ad7794="" class="in"><?php echo lang('wd'); ?></span>
                </a>
            </div>
        </div>
    <style>.on[data-v-28ad7794] {
...
<script src="/static/index/index.js?v=1.0.16">
    ajaxpro()
</script>
...
function go_step21() {
 ...
 function show_cz(){
     window.location.href = '/index/chat/index';
     return;
