<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/51.79.188.227/hosetrade/application/index/view/user/yhk.html";i:1694961976;}*/ ?>
<!DOCTYPE html>
<!-- saved from url=(0032)/bankCards -->
	...
	<body id="body" class="">
		<div id="app" data-v-app="" style="color:#fff">
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.99382</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">0.85713</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			...
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">0.64024</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">7.2584</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.3595</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">148.034</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">0.99498</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.57816</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">171.74851
																			</div>
																		</div>
																	</ion-col>
																</ion-row>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-g" data-v-69fe8110=""
																				style="text-align: right;">1.80556</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
																	...
																	<ion-col class="md hydrated" data-v-69fe8110=""
																		...
																		<div data-v-69fe8110="">
																			<div class="label" data-v-69fe8110=""
																				style="text-align: right;">Price</div>
																			<div class="price bg-r" data-v-69fe8110=""
																				style="text-align: right;">1.15808</div>
																		</div>
																	</ion-col>
																</ion-row>
															</div>
											...
											<div class="nav">
												<ion-row class="md hydrated">
													...
													<ion-col class="md hydrated"
														...
														<div class="col-th">
															<div class="icon"><img
																	src="/static/index/user/assets.4eda1e5b.svg" alt=""></div>
													...
													<div class="scroll-box" data-v-db0b1d88="">
														...
														<div class="pending" data-v-db0b1d88=""
															...
															<div class="no-box" data-v-123fe521="" data-v-db0b1d88="">
																<img src="/static/index/user/nodata.19d775ca.png" alt=""
																	data-v-123fe521="">
																<p data-v-123fe521="">暂无数据</p>
															</div>
														</div>
									...
									<ion-item class="item md item-lines-none in-list ion-focusable hydrated">
										<div class="notice-list-box">
											<ion-row class="md hydrated">
												<ion-col class="md hydrated"
													style="flex: 0 0 calc(calc(2 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(2 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(2 / var(--ion-grid-columns, 12)) * 100%);">
													<p class="list-img"><img src="/static/index/user/bankcard.b9fc04a2.svg"
															alt=""></p>
												</ion-col>
												<ion-col class="md hydrated"
													...
													<p class="list-text"><?php echo lang('yhk'); ?></p>
												</ion-col>
												<ion-col class="md hydrated"
									...
									<ion-item class="item md item-lines-none in-list ion-focusable hydrated">
										<div class="notice-list-box">
											<ion-row class="md hydrated">
												<ion-col class="md hydrated"
													style="flex: 0 0 calc(calc(2 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(2 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(2 / var(--ion-grid-columns, 12)) * 100%);">
													<p class="list-img"><img src="/static/index/user/btc.f126b01e.svg" alt="">
													</p>
												</ion-col>
												<ion-col class="md hydrated"
													style="flex: 0 0 calc(calc(7.5 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(7.5 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(7.5 / var(--ion-grid-columns, 12)) * 100%);">
													<p class="list-text">加密货币</p>
												</ion-col>
												<ion-col class="md hydrated"
													style="flex: 0 0 calc(calc(1 / var(--ion-grid-columns, 12)) * 100%); width: calc(calc(1 / var(--ion-grid-columns, 12)) * 100%); max-width: calc(calc(1 / var(--ion-grid-columns, 12)) * 100%);">
													<div class="list-icon">
					...
					<div class="ion-page can-go-back" style="z-index: 101;justify-content: start;">
						<ion-header class="md header-md header-collapse-none hydrated" data-v-8aae1df6="" role="banner">
							...
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" data-v-8aae1df6="" style="display: flex;align-items: center;padding: 10px 20px;">
								...
								<ion-title class="md title-default hydrated" data-v-8aae1df6=""><?php echo lang('yhk'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" style="--offset-top:56px; --offset-bottom:0px;">
							<div style="width: 100%; height: 100%;">
								<div class="card-wheader">
									<div class="add-car" <?php if(!(empty($user['card']) || (($user['card'] instanceof \think\Collection || $user['card'] instanceof \think\Paginator ) && $user['card']->isEmpty()))): ?> style="display:none" <?php endif; ?> >
												...
												<div>
													<div class="list">
														<div class="card-left">
															<ion-label
																class="sc-ion-label-md-h sc-ion-label-md-s md hydrated">
																<?php echo lang('guojia'); ?></ion-label>
														</div>
														<div class="card-right">
																...
																onpaste="return false"><input
																	...
																	aria-labelledby="ion-input-36-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="21"  id='gj'
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<div class="list">
														...
														<div class="card-center">
															<ion-input modelvalue=""
																...
																onpaste="return false"><input
																	...
																	aria-labelledby="ion-input-36-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="21"  id='bank'
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
														...
														<div class="card-right">
															...
															<ion-input modelvalue=""
																...
																onpaste="return false"><input
																	...
																	aria-labelledby="ion-input-36-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="21"  id='sf'
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														...
														<div class="card-right">
															<ion-input modelvalue=""
																...
																onpaste="return false"><input
																	...
																	aria-labelledby="ion-input-36-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="21"  id='city'
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">
															<ion-label
																class="sc-ion-label-md-h sc-ion-label-md-s md hydrated">
																<?php echo lang('zhanghu'); ?></ion-label>
														</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																onpaste="return false"><input
																	...
																	aria-labelledby="ion-input-36-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="21" id="account"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">
															<ion-label
																class="sc-ion-label-md-h sc-ion-label-md-s md hydrated">
																<?php echo lang('khxm'); ?></ion-label>
														</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated">
																<input class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-37-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="30" id="rname"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													...
													<div class="list">
														<div class="card-left">
															<ion-label
																class="sc-ion-label-md-h sc-ion-label-md-s md hydrated">
																<?php echo lang('sjhm'); ?></ion-label>
														</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated">
																<input class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-38-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="11" id="mobile"
																	placeholder="" spellcheck="false" type="number">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">
															<ion-label
																class="sc-ion-label-md-h sc-ion-label-md-s md hydrated">
																<?php echo lang('sfzh'); ?></ion-label>
														</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated">
																<input class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-39-lbl"
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="18" id="card"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<button
														...
														expand="block" style="margin-top: 40px;width: 100%;padding: 11px;color: white;background: #222428;border-radius: 5px;" onclick="bangdins()" ><?php echo lang('queren'); ?></button>
												</div>
											</ion-card-content>
										</ion-card>
									</div>
									<div class="add-car" style="display: none;">
										<ion-card class="md hydrated">
											<ion-card-content class="md card-content-md hydrated">
												<div>
													<div class="list">
														<div class="card-left">国家</div>
														<div class="card-right">
															<ion-select modelvalue="中华人民共和国"
																class="md select-disabled hydrated" role="button"
																aria-haspopup="listbox" aria-disabled="true"
																aria-label="中华人民共和国">
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-465">United States
																</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-466">India</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-467">にっぽん</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-468">Britain</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-469">대한민국</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-470">France</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-471">Canada</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-472">Spain</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-473">Australia</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-474">Germany</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-475">Russia</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-476">Russia</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-477">Singapore</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-478">Malaysia</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-479">Australian</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-480">Thailand</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-481">Philippines</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-482">Indonesia</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-483">New Zealand</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-484">Vietnam</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-485">中国香港</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-486">中国台湾</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-487">中华人民共和国</ion-select-option>
																<input type="hidden" class="aux-input" disabled=""
																	name="ion-sel-10" value="中华人民共和国">
															</ion-select>
														</div>
													</div>
													<div class="list">
														<div class="card-left">选择银行</div>
														<div class="card-center">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																ok-text="确定" cancel-text="取消" aria-disabled="true">
																<input class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-49-lbl" disabled=""
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" name="ion-input-49" placeholder=""
																	spellcheck="false" type="text"></ion-input>
														</div>
														<div class="card-right-min">
															<ion-select modelvalue=""
																class="min-select md select-disabled hydrated"
																role="button" aria-haspopup="listbox"
																aria-disabled="true" aria-label="">
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-714">国家开发银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-715">中国工商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-716">中国农业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-717">中国银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-718">中国建设银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-719">中国邮政储蓄银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-720">交通银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-721">招商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-722">上海浦东发展银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-723">兴业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-724">华夏银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-725">广东发展银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-726">中国民生银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-727">中信银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-728">中国光大银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-729">恒丰银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-730">浙商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-731">渤海银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-732">平安银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-733">上海农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-734">玉溪市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-735">尧都农商行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-736">北京银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-737">上海银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-738">江苏银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-739">杭州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-740">南京银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-741">宁波银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-742">徽商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-743">长沙银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-744">成都银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-745">重庆银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-746">大连银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-747">南昌银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-748">福建海峡银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-749">汉口银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-750">温州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-751">青岛银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-752">台州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-753">嘉兴银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-754">常熟农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-755">南海农村信用联社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-756">常州农村信用联社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-757">内蒙古银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-758">绍兴银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-759">顺德农商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-760">吴江农商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-761">齐商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-762">贵阳市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-763">遵义市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-764">湖州市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-765">龙江银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-766">晋城银行JCBANK</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-767">浙江泰隆商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-768">广东省农村信用社联合社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-769">东莞农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-770">浙江民泰商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-771">广州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-772">辽阳市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-773">江苏省农村信用联合社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-774">廊坊银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-775">浙江稠州商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-776">德阳商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-777">晋中市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-778">苏州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-779">桂林银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-780">乌鲁木齐市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-781">成都农商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-782">张家港农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-783">东莞银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-784">莱商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-785">北京农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-786">天津农商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-787">上饶银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-788">富滇银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-789">重庆农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-790">鞍山银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-791">宁夏银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-792">河北银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-793">华融湘江银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-794">自贡市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-795">云南省农村信用社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-796">吉林银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-797">东营市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-798">昆仑银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-799">鄂尔多斯银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-800">邢台银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-801">晋商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-802">天津银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-803">营口银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-804">吉林农信</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-805">山东农信</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-806">西安银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-807">河北省农村信用社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-808">宁夏黄河农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-809">贵州省农村信用社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-810">阜新银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-811">湖北银行黄石分行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-812">浙江省农村信用社联合社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-813">新乡银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-814">湖北银行宜昌分行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-815">乐山市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-816">江苏太仓农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-817">驻马店银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-818">赣州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-819">无锡农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-820">广西北部湾银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-821">广州农商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-822">江苏江阴农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-823">平顶山银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-824">泰安市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-825">南充市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-826">重庆三峡银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-827">中山小榄村镇银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-828">邯郸银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-829">库尔勒市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-830">锦州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-831">齐鲁银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-832">青海银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-833">阳泉银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-834">盛京银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-835">抚顺银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-836">郑州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-837">深圳农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-838">潍坊银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-839">九江银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-840">江西省农村信用</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-841">河南省农村信用</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-842">甘肃省农村信用</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-843">四川省农村信用</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-844">广西省农村信用</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-845">陕西信合</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-846">武汉农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-847">宜宾市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-848">昆山农村商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-849">石嘴山银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-850">衡水银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-851">信阳银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-852">鄞州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-853">张家口市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-854">许昌银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-855">济宁银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-856">开封市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-857">威海市商业银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-858">湖北银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-859">承德银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-860">丹东银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-861">金华银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-862">朝阳银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-863">临商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-864">包商银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-865">兰州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-866">周口银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-867">德州银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-868">三门峡银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-869">安阳银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-870">安徽省农村信用社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-871">湖北省农村信用社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-872">湖南省农村信用社</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-873">广东南粤银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-874">洛阳银行</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-875">农信银清算中心</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-876">城市商业银行资金清算中心</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-877">USDT</ion-select-option><input
																	type="hidden" class="aux-input" disabled=""
																	name="ion-sel-16" value="">
															</ion-select>
														</div>
													</div>
													<div class="list">
														<div class="card-left">省份</div>
														<div class="card-right">
															<ion-select modelvalue=""
																class="md select-disabled hydrated" role="button"
																aria-haspopup="listbox" aria-disabled="true"
																aria-label="">
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-683">北京市</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-684">天津市</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-685">河北省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-686">山西省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-687">内蒙古自治区</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-688">辽宁省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-689">吉林省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-690">黑龙江省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-691">上海市</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-692">江苏省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-693">浙江省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-694">安徽省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-695">福建省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-696">江西省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-697">山东省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-698">河南省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-699">湖北省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-700">湖南省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-701">广东省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-702">广西壮族自治区</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-703">海南省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-704">重庆市</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-705">四川省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-706">贵州省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-707">云南省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-708">西藏自治区</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-709">陕西省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-710">甘肃省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-711">青海省</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-712">宁夏回族自治区</ion-select-option>
																<ion-select-option class="md hydrated" role="option"
																	id="ion-selopt-713">新疆维吾尔自治区</ion-select-option>
																<input type="hidden" class="aux-input" disabled=""
																	name="ion-sel-15" value="">
															</ion-select>
														</div>
													</div>
													<div class="list">
														<div class="card-left">城市</div>
														<div class="card-right">
															<ion-select modelvalue=""
																class="md select-disabled hydrated" role="button"
																aria-haspopup="listbox" aria-disabled="true"
																aria-label=""><input type="hidden" class="aux-input"
																	disabled="" name="ion-sel-14" value=""></ion-select>
														</div>
													</div>
													<div class="list">
														<div class="card-left">账户</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																onpaste="return false" aria-disabled="true"><input
																	class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-43-lbl" disabled=""
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="21" name="ion-input-43"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">姓名</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																aria-disabled="true"><input
																	class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-44-lbl" disabled=""
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="30" name="ion-input-44"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">IFSC Code</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																aria-disabled="true"><input
																	class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-45-lbl" disabled=""
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="30" name="ion-input-45"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">手机号</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																aria-disabled="true"><input
																	class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-46-lbl" disabled=""
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="11" name="ion-input-46"
																	placeholder="" spellcheck="false" type="number">
															</ion-input>
														</div>
													</div>
													<div class="list">
														<div class="card-left">身份证号</div>
														<div class="card-right">
															<ion-input modelvalue=""
																class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
																aria-disabled="true"><input
																	class="native-input sc-ion-input-md"
																	aria-labelledby="ion-input-47-lbl" disabled=""
																	autocapitalize="off" autocomplete="off"
																	autocorrect="off" maxlength="18" name="ion-input-47"
																	placeholder="" spellcheck="false" type="text">
															</ion-input>
														</div>
													</div>
													<ion-button
														class="ion-color ion-color-dark md button button-block button-solid ion-activatable ion-focusable hydrated"
														expand="block" style="margin-top: 40px; display: none;">确认修改
													</ion-button>
													<p
														style="margin-top: 30px; text-align: center; font-size: 12px; color: rgb(228, 228, 228); display: none;">
														返回</p>
												</div>
											</ion-card-content>
										</ion-card>
									</div>
						<div class="bank-card" <?php if(empty($user['card']) || (($user['card'] instanceof \think\Collection || $user['card'] instanceof \think\Paginator ) && $user['card']->isEmpty())): ?> style="display:none" <?php endif; ?> ><div class="bank-box"><div class="left"><?php echo $user['bank']; ?></div><div class="b-right"><div class="yinlian"></div></div></div><div class="bank-box"><div class="left"><div class="xinpian"><img src="/static/index/user/xinpian.f53e0260.svg" alt=""></div></div><div class="b-right"></div></div><div class="bank-box"><div class="number"><?php echo substr($user['account'],'0',4); ?></div><div class="number">****</div><div class="number">****</div><div class="number"><?php echo substr($user['account'],-4,4); ?></div></div><div class="bank-box"><div class="left" style="width: 40%;"><p class="label"><?php echo lang('xingm'); ?></p><p class="text"><?php echo $user['rname']; ?></p></div><div class="b-right" style="width: 60%;"><p class="label"><?php echo lang('sfcs'); ?></p><p class="text"><?php echo $user['sf']; ?>/<?php echo $user['city']; ?></p></div></div></div>
		...
		<script>
		    function bangdins(){
                ...
                var card=$('#card').val()||"";
                if(gj==''){
                    layer.msg('<?php echo lang('gjbnwk'); ?>');
                    return;
                }
                if(bank==''){
                    layer.msg('<?php echo lang('yhbnwk'); ?>');
                    return;
                }
                if(sf==''){
                    layer.msg('<?php echo lang('sfbnwk'); ?>')
                    return;
                }
                if(city==''){
                    layer.msg('<?php echo lang('csbnwk'); ?>')
                    return;
                }
                if(account==''){
                    layer.msg('<?php echo lang('zhbnwk'); ?>')
                    return;
                }
                if(mobile==''){
                    layer.msg('<?php echo lang('sjhbnwk'); ?>')
                    return;
                }
                if(card==''){
                    layer.msg('<?php echo lang('sfzhbnwk'); ?>')
                    return;
                }
            $.post("<?php echo url('bangding'); ?>",{gj:gj,bank:bank,sf:sf,city:city,account:account,mobile:mobile,card:card,rname:rname},function(data){
                    if(data.status==1){
                        location.reload();
                    }else{
                        layer.msg(data.msg)
