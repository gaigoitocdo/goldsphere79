<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/51.79.209.207/application/index/view/user/useragent.html";i:1694961976;}*/ ?>
        ...
        <ion-nav-view class="view-container" nav-view-transition="ios" nav-view-direction="none" nav-swipe="">
            <ion-tabs class="tabs-icon-top navbar pane tabs-bottom tabs-standard" abstract="true" nav-view="active"
                    ...
                    <div class="nav-bar-block" nav-bar="active">
                        <ion-header-bar class="bar-stable headerbar bar bar-header" align-title="center">
                            <div class="title title-center header-item"
                                 style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);"><?php echo lang('wdxx'); ?></div>
                        </ion-header-bar>
                    </div>
                </ion-nav-bar>
                ...
                <ion-content
                        ...
                        scroll="false" style="margin-top: 10% ;">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <div class="user_btn">
                        <h5>用户ID：<?php echo $vo['uid']; ?></h5>
                        <h5>用户名：<?php echo $vo['username']; ?></h5>
                        <h5>当前余额：<?php echo $vo['usermoney']; ?></h5>
                    </div>
