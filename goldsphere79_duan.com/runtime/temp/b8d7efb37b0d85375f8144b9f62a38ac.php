<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/51.79.188.227/hosetrade/application/index/view/login/login.html";i:1694961976;}*/ ?>
<!DOCTYPE html>
...
<html lang="en" mode="md" class="plt-iphone plt-ios plt-mobile plt-mobileweb md hydrated">
    ...
    <!--    </ul>-->
											...
											<p class="title" data-v-ebea41ae=""><?php echo lang('login'); ?></p>
									...
									<button style="position: relative;top: 35px;background-color: #efc23e;color: black;padding: 10px 50px;width:100%;border-radius: 6px;" onclick="return checkform(this.form);" class="md button button-block button-solid ion-activatable ion-focusable hydrated" data-v-ebea41ae="" expand="block" style="margin-top: 35px;"><?php echo lang('login'); ?></button>
									</form>
								</div>
								<div data-v-ebea41ae="" style="text-align:center;color:#fff;margin-top:50px;font-size:14px"><span data-v-ebea41ae=""
													style="margin-right: 5px;"><?php echo lang('myzh'); ?></span><span class="a"
													data-v-ebea41ae=""><a href="<?php echo url('login/register'); ?>"><?php echo lang('register'); ?></a></span></div>
							</div>
						</ion-content>
					</div>
				</ion-router-outlet>
