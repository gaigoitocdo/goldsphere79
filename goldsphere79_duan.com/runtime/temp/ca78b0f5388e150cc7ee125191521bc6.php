<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/www/wwwroot/isetradingstar.com/application/lord/view/order/orderlog.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<!--main content start-->
      <section id="main-content">
          <section class="wrapper">
                ...
                <div class="row">
                      ...
                      <div class="col-lg-3 mar-10">
                        <div class="input-group">
                            ...
                            <input type="text" value="<?php echo !empty($getdata['username'])?$getdata['username']:''; ?>"  class="form-control" name="username" placeholder="Biệt danh/Tên/Điện thoại/Số thứ tự"/>
                        </div>
                      </div>

                      <div class="col-lg-6 mar-10">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">Thời gian đóng cửa</span>
                  ...
                  <div class="mar-10">
                   <input type="submit" class="btn btn-success" value="正常Tìm kiếm">
            ...
            <a href="<?php echo url('order/orderlog'); ?>"><button type="submit" class="btn btn-danger">Tìm kiếm tất cả</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <br><br>
             <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
