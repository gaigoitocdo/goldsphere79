<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"/www/wwwroot/isetradingstar.com/application/lord/view/user/myteam.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                      ...
                      <section class="panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
                            <div class="div_my_son">
                              <ul class="my_sons">
                                <li>Đại lý：<?php echo $mysons['username']; ?> Số dư: <?php echo $mysons['usermoney']; ?></li>
                                <li>Điện thoại: <?php echo $mysons['utel']; ?> <a href="/lord/user/userlist.html?uid=<?php echo $mysons['uid']; ?>"><button class="btn btn-primary btn-xs">Chi tiết</button></a></li>
                              </ul>
