<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/www/wwwroot/isetradingstar.com/application/lord/view/goods/huishou.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/head.html";i:1690248718;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/menu.html";i:1747597993;s:63:"/www/wwwroot/isetradingstar.com/application/lord/view/foot.html";i:1747598054;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
                          ...
                          <!-- <?php if(is_array($proinfo) || $proinfo instanceof \think\Collection || $proinfo instanceof \think\Paginator): $i = 0; $__LIST__ = $proinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> -->
                              <tr>
                                  ...
                                  <td>
                                       ...
                                       <a class="btn btn-danger btn-xs" onclick="hyinfo('<?php echo $vo['pid']; ?>')">Nhấp để khôi phục</a>
                                  </td>
                              </tr>
...
//hy info
	function hyinfo(id){
		layer.open({
		  content: 'Bạn có chắc muốn khôi phục không',
		  yes: function(index){
		    //do something
