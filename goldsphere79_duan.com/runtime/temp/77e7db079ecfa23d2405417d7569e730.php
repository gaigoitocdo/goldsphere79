<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/www/wwwroot/51.79.209.207/application/lord/view/project/index.html";i:1755690830;s:58:"/www/wwwroot/51.79.209.207/application/lord/view/head.html";i:1690248718;s:58:"/www/wwwroot/51.79.209.207/application/lord/view/menu.html";i:1747597993;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row state-overview">
      <div class="container">
        <form action="<?php echo url('admin/Project/index'); ?>" method="get" class="form-inline">
          <div class="row">

            <div class="col-lg-4 mar-10">
              <div class="input-group">
                <span class="input-group-addon">Từ khóa</span>
                <input type="text" name="keyword" class="form-control" placeholder="Tiêu đề/ID"
                       value="<?php echo (isset($getdata['keyword']) && ($getdata['keyword'] !== '')?$getdata['keyword']:''); ?>">
              </div>
            </div>
            ...
            <div class="col-lg-3 mar-10">
              <div class="input-group">
                ...
                <select name="status" class="selectpicker show-tick form-control">
                  ...
                  <option value="1" <?php if(isset($getdata['status']) && $getdata['status'] === 1): ?>selected<?php endif; ?>>Mở</option>
                  <option value="0" <?php if(isset($getdata['status']) && $getdata['status'] === 0): ?>selected<?php endif; ?>>Ẩn</option>
                  <option value="2" <?php if(isset($getdata['status']) && $getdata['status'] === 2): ?>selected<?php endif; ?>>Kết thúc</option>
                </select>
              </div>
            </div>
            ...
            <div class="col-lg-5 mar-10">
              <div class="input-group">
                ...
                <input type="date" name="start" class="form-control" value="<?php echo (isset($getdata['start']) && ($getdata['start'] !== '')?$getdata['start']:''); ?>">
                <span class="input-group-addon">Đến</span>
                <input type="date" name="end" class="form-control" value="<?php echo (isset($getdata['end']) && ($getdata['end'] !== '')?$getdata['end']:''); ?>">
              </div>
            </div>

            <div class="mar-10">
              <input type="submit" class="btn btn-success" value="Tìm kiếm">
              <a href="<?php echo url('admin/Project/index', ['today'=>1]); ?>" class="btn btn-info">Hôm nay</a>
              <a href="<?php echo url('admin/Project/index'); ?>" class="btn btn-default">Tất cả</a>
              <a href="<?php echo url('admin/Project/index', ['status'=>1]); ?>" class="btn btn-primary">Đang mở</a>
              <a href="<?php echo url('admin/Project/index', ['status'=>0]); ?>" class="btn btn-warning">Đang ẩn</a>
              <a href="<?php echo url('admin/Project/index', ['status'=>2]); ?>" class="btn btn-danger">Kết thúc</a>
              <a href="<?php echo url('admin/Project/create'); ?>" class="btn btn-success">+ Thêm dự án</a>
            </div>
