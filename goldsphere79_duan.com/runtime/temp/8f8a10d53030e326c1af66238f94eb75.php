<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/wwwroot/isetradingstar.com/application/index/view/chat/index.html";i:1747627276;}*/ ?>
<!DOCTYPE html>
<html>
...
<body style="background: #000; font-size: 16px;padding: 15px;box-sizing:border-box">
    <style>
        .chat-container {
            max-width: 500px;
            margin: auto;
...
<div id="app" style="height: 100%;position: fixed;width: 100%; max-width: 1600px;position: fixed;height: 90%">
...
<div data-v-28ad7794="" data-v-0c912c96="" class="box" id="oukes" style="bottom:0px;display: flex;">
            ...
            <div data-v-28ad7794="" style="flex: 1 1 0%; background-color: rgb(20,20,20)">
                ...
                <a data-v-28ad7794="" href="#" id="redires" class="li">
