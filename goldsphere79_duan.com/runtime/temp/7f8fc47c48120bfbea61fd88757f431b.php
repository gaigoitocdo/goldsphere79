<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/goldsphere79.com/application/index/view/login/register.html";i:1755885073;}*/ ?>
<!DOCTYPE html>
...
.native-input.sc-ion-input-md, .r-input, .login .login-box .from .input[data-v-ebea41ae] {
    background: #fff;
    position: relative;
}
input {
...
.input-clear-icon.sc-ion-input-md{display:none}
.login .login-box[data-v-ebea41ae]{margin:50px auto 0}
  ...
  .toggle-password {
		...
		<div id="app" data-v-app="">
			<ion-app class="md ion-page hydrated">
				<ion-router-outlet id="ion-router-outlet" class="hydrated">
					<div class="ion-pages" data-v-ebea41ae="">
						<ion-header class="md header-md header-collapse-none hydrated" role="banner">
							...
							<ion-toolbar class="toolbar-title-default md in-toolbar hydrated" style="display: flex;align-items: center;padding: 10px 20px;background:linear-gradient(90deg,#00527a,#00537f);color:#fff;justify-content:center;text-transform:uppercase">
								...
								<ion-title class="md title-default hydrated"><?php echo lang('zcdl'); ?></ion-title>
							</ion-toolbar>
						</ion-header>
						<ion-content class="md hydrated" data-v-ebea41ae=""
							...
							<div class="login" data-v-ebea41ae="">
								<div class="login-box" data-v-ebea41ae="">
									<div class="top" data-v-ebea41ae=""><span class="left1" data-v-ebea41ae=""><img
												src="https://ibgoldworld.pro/h5/static/logo.png" alt=""
												data-v-ebea41ae="" style="max-width:300px;max-height:100px;margin:0 auto"></span><span class="right1" data-v-ebea41ae="">
    ...
    <!--    </ul>-->
											...
											<p class="title" data-v-ebea41ae="" style="font-size:16px;color:#666;margin:15px 0;font-weight:bold"><?php echo lang('zcdl'); ?></p>
									...
									<div class="from" style="    text-align: left;">
											...
											<ion-input modelvalue=""
												...
												data-v-ebea41ae=""><input class="native-input sc-ion-input-md"
													...
													name="nickname" placeholder="<?php echo lang('username'); ?>" required=""
													 type="text"><button aria-label="reset"
										...
										<div class="input password-wrapper" data-v-ebea41ae="">
											<ion-input modelvalue=""
												class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
												data-v-ebea41ae=""><input class="native-input sc-ion-input-md"
													
													 minlength="6" maxlength="32"
													id="upwd" name="upwd" placeholder="<?php echo lang('password'); ?>" required=""
													 type="password">
											</ion-input>
											<i class="fa fa-eye toggle-password" onclick="togglePassword('upwd', this)"></i>
										</div>
										...
										<div class="input password-wrapper" data-v-ebea41ae="">
											<ion-input modelvalue=""
												...
												data-v-ebea41ae=""><input class="native-input sc-ion-input-md"
													 ...
													 minlength="6" maxlength="32"
													id="upwd2" name="upwd2" placeholder="<?php echo lang('mmcd'); ?>" required=""
													 type="text">
											</ion-input>
											<i class="fa fa-eye toggle-password" onclick="togglePassword('upwd2', this)"></i>
										</div>
										...
										<div class="input password-wrapper" data-v-ebea41ae="">
											<ion-input modelvalue=""
												...
												data-v-ebea41ae=""><input class="native-input sc-ion-input-md"
													 ...
													 minlength="6" maxlength="32"
												    id="paypwd"	name="paypwd" placeholder="<?php echo lang('srzfmm'); ?>" required=""
													 type="text">
											</ion-input>
											<i class="fa fa-eye toggle-password" onclick="togglePassword('paypwd', this)"></i>
										</div>
										<div class="lable" data-v-ebea41ae=""><?php echo lang('tjm'); ?></div>
										<div class="input" data-v-ebea41ae="">
											<ion-input modelvalue=""
												class="sc-ion-input-md-h sc-ion-input-md-s md hydrated"
												data-v-ebea41ae=""><input class="native-input sc-ion-input-md"
													aria-labelledby="ion-input-0-lbl" 
													 maxlength="5"
													name="oid" placeholder="<?php echo lang('tjm'); ?>" required=""
													 type="text">
											</ion-input>
										</div>
									</div>
									<button style="position: relative;top: 35px;background: linear-gradient(90deg,#00527a,#00537f);color: #fff;padding: 10px 50px;width:100%;border-radius: 6px;" onclick="return checkform(this.form);" class="md button button-block button-solid ion-activatable ion-focusable hydrated" data-v-ebea41ae="" expand="block" style="margin-top: 35px;"><?php echo lang('zcdl'); ?></button>
									</form>
								</div>
								<div data-v-ebea41ae="" style="text-align:center;color:red;margin-top:50px;font-size:14px"><span data-v-ebea41ae=""
													style="margin-right: 5px;"></span><span class="a"
													data-v-ebea41ae=""><a href="<?php echo url('login/login'); ?>" style="color:red"><?php echo lang('yyzhdl'); ?></a></span></div>
							</div>
						</ion-content>
					</div>
				</ion-router-outlet>
